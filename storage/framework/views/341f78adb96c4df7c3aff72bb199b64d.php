                                ...
                                <div class="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <input type="color" name="navbar[dot_color]" value="<?php echo e(old('navbar.dot_color', data_get($page->content, 'navbar.dot_color', '#ff6900'))); ?>" class="w-10 h-10 rounded-md cursor-pointer border-0 p-0 bg-transparent">
                                                <input type="text" name="navbar[dot_color_text]" value="<?php echo e(old('navbar.dot_color', data_get($page->content, 'navbar.dot_color', '#ff6900'))); ?>" class="flex-1 bg-white border border-slate-200 rounded-md px-3 text-[0.7rem] font-mono text-slate-500">
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div class="space-y-2">
                                            ...
                                            <div id="rte_announcement" style="border:1.5px solid #e2e8f0;border-radius:6px;background:#fff;transition:border-color .2s;">
                                                <?php echo $__env->make('admin.cms._rte_toolbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <div class="flex gap-1.5" id="hero-scale-choices">
                                        <?php $__currentLoopData = [1, 1.25, 1.5, 1.8]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" data-scale="<?php echo e($scale); ?>" class="hero-scale-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e((string) data_get($page->content, 'hero.car_scale', 1) === (string) $scale ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="hero_car_mirror" id="hero_car_mirror" value="<?php echo e(old('hero_car_mirror', data_get($page->content, 'hero.car_mirror', 0))); ?>">
                                    <div class="flex gap-1.5">
                                        <button type="button" data-mirror="0" class="hero-mirror-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(!data_get($page->content, 'hero.car_mirror', 0) ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                            <i data-lucide="image" class="w-2.5 h-2.5"></i> Normal
                                        </button>
                                        <button type="button" data-mirror="1" class="hero-mirror-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.car_mirror', 0) ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-1.5">
                                        <button type="button" data-overlay="1" class="hero-overlay-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.background_overlay_enabled', true) ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                            <i data-lucide="eye" class="w-2.5 h-2.5"></i> On
                                        </button>
                                        <button type="button" data-overlay="0" class="hero-overlay-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(!data_get($page->content, 'hero.background_overlay_enabled', true) ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="hero_circles_enabled" id="hero_circles_enabled" value="<?php echo e(old('hero_circles_enabled', data_get($page->content, 'hero.circles_enabled', true) ? 1 : 0)); ?>">
                                    <div class="flex gap-1.5">
                                        <button type="button" data-circles="1" class="hero-circles-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.circles_enabled', true) ? 'bg-[#ff6900] text-white border-[#ff6900]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                                            <i data-lucide="sparkles" class="w-2.5 h-2.5"></i> Enabled
                                        </button>
                                        <button type="button" data-circles="0" class="hero-circles-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(!data_get($page->content, 'hero.circles_enabled', true) ? 'bg-[#031629] text-white border-[#031629]' : 'bg-slate-50 border-slate-100 text-slate-600'); ?>">
                            ...
                            <div class="bg-slate-50 p-4 rounded-md border border-slate-100 space-y-4">
                                <div>
                                    ...
                                    <div class="flex gap-2 mb-2">
                                        <button type="button" data-mode="solid" class="hero-mode-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.background_mode', 'image') === 'solid' ? 'bg-[#031629] text-white' : 'bg-white border-slate-200 text-slate-500'); ?>">
                                            <i data-lucide="square" class="w-3 h-3"></i> Solid
                                        </button>
                                        <button type="button" data-mode="gradient" class="hero-mode-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.background_mode', 'image') === 'gradient' ? 'bg-[#031629] text-white' : 'bg-white border-slate-200 text-slate-500'); ?>">
                                            <i data-lucide="layers" class="w-3 h-3"></i> Gradient
                                        </button>
                                        <button type="button" data-mode="image" class="hero-mode-btn flex-1 py-1.5 rounded-lg text-[0.6rem] font-medium border transition-all flex items-center justify-center gap-1 <?php echo e(data_get($page->content, 'hero.background_mode', 'image') === 'image' ? 'bg-[#031629] text-white' : 'bg-white border-slate-200 text-slate-500'); ?>">
                                ...
                                <div id="custom-css-controls" class="<?php echo e(data_get($page->content, 'hero.background_mode', 'image') === 'custom' ? '' : 'hidden'); ?>">
                                    ...
                                    <textarea name="hero_custom_css" id="hero_custom_css" rows="3" class="w-full bg-[#031629] text-orange-400 font-mono text-[0.65rem] p-3 rounded-md border border-orange-500/20 focus:border-orange-500 outline-none" placeholder="e.g. background: repeating-linear-gradient(...);"><?php echo e(old('hero_custom_css', data_get($page->content, 'hero.custom_css'))); ?></textarea>
                                </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                <div class="col-span-2">
                                                    ...
                                                    <input type="text" name="lead_form[plate][subtitle]" value="<?php echo e(old('lead_form.plate.subtitle', data_get($page->content, 'lead_form.plate.subtitle', 'Selected Plate Details'))); ?>" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-500 outline-none">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="space-y-4">
                                            ...
                                            <div class="space-y-4 pt-4 border-t border-blue-50">
                                                ...
                                                <div class="grid grid-cols-2 gap-4">
                                                    <div>
                                                        ...
                                                        <textarea name="lead_form[step2][specs_options]" rows="4" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.specs_options', data_get($page->content, 'lead_form.step2.specs_options', "GCC Specs\nAmerican Specs\nJapanese Specs\nKorean Specs\nCanadian Specs\nOther / European\nI don't know"))); ?></textarea>
                                                    </div>
                                                    <div>
                                                        <label class="text-[0.5rem] font-medium uppercase tracking-widest text-slate-400 mb-1 block">Body Types (One per line)</label>
                                                        <textarea name="lead_form[step2][body_options]" rows="4" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.body_options', data_get($page->content, 'lead_form.step2.body_options', "Sedan\nSUV\nCrossover\nCoupe\nConvertible\nHard top convertible\nSoft top convertible\nWagon\nHatchback\nVan\nPickup\nI don't know"))); ?></textarea>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <textarea name="lead_form[step2][engine_options]" rows="3" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.engine_options', data_get($page->content, 'lead_form.step2.engine_options', '1.0L, 1.2L, 1.4L, 1.6L, 1.8L, 2.0L, 2.2L, 2.4L, 2.5L, 3.0L, 3.5L, 3.8L, 4.0L, 4.4L, 4.8L, 5.0L, 5.5L, 6.0L, Other'))); ?></textarea>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <textarea name="lead_form[step2][mileage_options]" rows="3" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.mileage_options', data_get($page->content, 'lead_form.step2.mileage_options', "Up to 5,000 KM\nUp to 10,000 KM\nUp to 20,000 KM\nUp to 40,000 KM\nUp to 60,000 KM\nUp to 100,000 KM\nUp to 150,000 KM\nUp to 200,000 KM\nMore than 250,000 KM"))); ?></textarea>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <textarea name="lead_form[step2][paint_options]" rows="3" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.paint_options', data_get($page->content, 'lead_form.step2.paint_options', "Original Paint\n1-2 Panels Repaint\n3+ Panels Repaint\nMajor Accident Repaint\nTotal Repaint\nUnknown"))); ?></textarea>
                                                    </div>
                                                    <div>
                                                        <label class="text-[0.5rem] font-medium uppercase tracking-widest text-slate-400 mb-1 block">Trim Options (One per line)</label>
                                                        <textarea name="lead_form[step2][trim_options]" rows="3" class="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-[0.65rem] font-medium text-slate-600 focus:border-blue-500 outline-none resize-none"><?php echo e(old('lead_form.step2.trim_options', data_get($page->content, 'lead_form.step2.trim_options', "Basic\nMid\nFull\nUnknown"))); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
window.__footerLinks = <?php echo json_encode($_footerLinks); ?>;
window.__footerPages = <?php echo json_encode($_footerPages); ?>;
window.__rteInitial = {
    hero_announcement: <?php echo json_encode(old('hero_announcement', data_get($page->content, 'hero.announcement', ''))); ?>,
    hero_title:        <?php echo json_encode(old('hero_title',        data_get($page->content, 'hero.title', ''))); ?>,
    hero_subtitle:     <?php echo json_encode(old('hero_subtitle',     data_get($page->content, 'hero.subtitle', ''))); ?>
...
window.__cmsPageData = {
    ...
    lfStep: 1,
    isSaving: false,
    navbarBg:     <?php echo json_encode(data_get($page->content, 'navbar.bg_color', '#ffffff')); ?>,
    navbarText:   <?php echo json_encode(data_get($page->content, 'navbar.text_color', '#1e293b')); ?>,
    navbarSticky: <?php echo e(data_get($page->content, 'navbar.sticky', true)  ? 'true' : 'false'); ?>,
    navbarGlass:  <?php echo e(data_get($page->content, 'navbar.glass',  false) ? 'true' : 'false'); ?>,
    lfShowHero: <?php echo e(data_get($page->content, 'lead_form.show_hero_form', true) ? 'true' : 'false'); ?>,
    async saveForm(e) {
        this.isSaving = true;
        document.querySelectorAll('[contenteditable="true"][data-target]').forEach(function(editor) {
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/cms/home.blade.php ENDPATH**/ ?>