...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-standard','data' => ['icon' => 'briefcase','title' => 'Position','highlight' => 'Manager','subtitle' => 'Manage corporate roles and operational responsibilities','dot' => 'orange']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'briefcase','title' => 'Position','highlight' => 'Manager','subtitle' => 'Manage corporate roles and operational responsibilities','dot' => 'orange']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-data-view','data' => ['alpine' => true,'alpineCount' => 'positions.length','emptyTitle' => 'No Positions Defined','emptySubtitle' => 'The position hierarchy is currently empty. Create your first position to begin workforce mapping.','emptyIcon' => 'briefcase']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['alpine' => true,'alpineCount' => 'positions.length','emptyTitle' => 'No Positions Defined','emptySubtitle' => 'The position hierarchy is currently empty. Create your first position to begin workforce mapping.','emptyIcon' => 'briefcase']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-modal','data' => ['xShow' => 'opened','title' => 'Position Details','icon' => 'briefcase','size' => 'max-w-4xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'opened','title' => 'Position Details','icon' => 'briefcase','size' => 'max-w-4xl']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.elite-select','data' => ['label' => 'Parent Department','icon' => 'layers','xModel' => 'form.department_id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Parent Department','icon' => 'layers','x-model' => 'form.department_id']); ?>
...
<script>
    function positionManager() {
        return {
            ...
            async fetchData() {
                let url = `<?php echo e(route('admin.hr.positions.index')); ?>?search=${this.search}`;
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\auction_app\resources\views/admin/hr/positions/index.blade.php ENDPATH**/ ?>