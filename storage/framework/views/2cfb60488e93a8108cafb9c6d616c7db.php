<?php $__env->startSection('title', 'Inspection Report · ' . ($report->car?->make ?? 'Asset') . ' ' . ($report->car?->model ?? '')); ?>
...
<div class="pb-24 space-y-5">
            ...
            <div class="relative">
                <div class="w-14 h-14 rounded-lg bg-[#1d293d] overflow-hidden shadow-xl p-3 flex items-center justify-center transform rotate-3">
                    ...
                    <?php if(file_exists(public_path($logoPath))): ?>
                        <img src="<?php echo e(asset($logoPath)); ?>" class="w-full h-full object-contain filter brightness-0 invert opacity-90">
                    <?php else: ?>
                ...
                <?php $scoreColor = $report->overall_score >= 80 ? 'bg-emerald-500' : ($report->overall_score >= 60 ? 'bg-amber-400' : 'bg-red-500'); ?>
                <div class="absolute -bottom-1 -right-1 w-5 h-5 rounded-lg <?php echo e($scoreColor); ?> border-[3px] border-[#f8fafc] animate-pulse"></div>
            </div>

            
            <div>
                <h1 class="text-4xl font-black text-[#031629] uppercase italic tracking-tighter leading-none">
                    <?php echo e($report->car?->year ?? ''); ?> <?php echo e($report->car?->make ?? 'Unknown'); ?>

                    <span class="text-[#ff6900]"><?php echo e($report->car?->model ?? 'Asset'); ?></span>
                </h1>
                <div class="flex items-center gap-3 mt-2.5">
                    ...
                    <span class="text-[0.58rem] font-mono font-bold text-slate-400 uppercase tracking-tighter">
                        #RP-<?php echo e(str_pad($report->id, 6, '0', STR_PAD_LEFT)); ?>

                    </span>
                    <?php if($report->car?->vin): ?>
                    <span class="text-slate-200">·</span>
                    <span class="text-[0.58rem] font-mono font-bold text-[#ff6900] uppercase"><?php echo e($report->car->vin); ?></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-5">
                ...
                <div class="flex items-center gap-6 p-5 bg-[#f0f2f5]">
                    ...
                    <div class="relative w-20 h-20 flex-shrink-0">
                        ...
                        <svg class="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 80 80">
                            ...
                            <circle cx="40" cy="40" r="32" fill="transparent" stroke="<?php echo e($scoreHex); ?>" stroke-width="7"
                                    stroke-dasharray="<?php echo e($circumference); ?>" stroke-dashoffset="<?php echo e($offset); ?>"
                                    stroke-linecap="round"/>
                        </svg>
                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                            <span class="text-xl font-black text-[#1d293d] leading-none tabular-nums"><?php echo e($report->overall_score); ?></span>
                    ...
                    <div class="grid grid-cols-5 gap-3 flex-1">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $score]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-lg border border-slate-200 px-2 py-2 text-center">
                            <div class="text-[0.48rem] font-black text-slate-400 uppercase tracking-widest mb-1"><?php echo e($label); ?></div>
                            <div class="text-sm font-black text-[#1d293d]"><?php echo e($score); ?><span class="text-[0.5rem] text-slate-400">%</span></div>
                            <div class="mt-1.5 h-1 rounded-full bg-slate-100 overflow-hidden">
                                <div class="h-full rounded-full <?php echo e($score >= 80 ? 'bg-emerald-500' : ($score >= 60 ? 'bg-amber-400' : 'bg-red-400')); ?>"
            ...
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <div class="divide-y divide-slate-100">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $score, $notes, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-5 py-4">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[0.65rem] font-black text-[#1d293d] uppercase tracking-widest"><?php echo e($label); ?></span>
                            <span class="text-[0.65rem] font-black tabular-nums" style="color: <?php echo e($color); ?>"><?php echo e($score); ?>%</span>
                        </div>
                        <div class="h-1.5 bg-slate-100 rounded-full overflow-hidden">
                            <div class="h-full rounded-full transition-all duration-700" style="width: <?php echo e($score); ?>%; background: <?php echo e($color); ?>"></div>
                        </div>
                        <?php if($notes): ?>
            ...
            <?php if(!empty($report->detailed_checklists)): ?>
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
                <div class="flex items-center gap-3 px-6 py-4 bg-slate-50 border-b border-slate-200">
                    ...
                    <div class="ml-auto flex items-center gap-2">
                        ...
                        <span class="text-[0.55rem] font-black px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-500 shadow-sm">
                            <?php echo e($totalFields); ?> DATA POINTS LOGGED
                        </span>
                    </div>
                </div>
                ...
                <div class="p-0">
                    <div class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $report->detailed_checklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php 
                            ...
                            <div class="p-5 flex flex-col md:flex-row gap-4 hover:bg-slate-50/50 transition-colors">
                                ...
                                <div class="md:w-1/3">
                                    <div class="flex items-center gap-2 mb-1.5">
                                        ...
                                        <h3 class="text-[0.65rem] font-black text-slate-500 uppercase tracking-widest leading-none"><?php echo e($field['label'] ?? 'Unknown Component'); ?></h3>
                                    </div>
                                    <div class="text-[0.5rem] font-mono font-bold text-slate-300 uppercase tracking-tighter">
                                        Type: <?php echo e(strtoupper(str_replace('_', ' ', $fType))); ?>
                                ...
                                <div class="flex-1">
                                    <?php if($fType === 'image'): ?>
                                        <?php if($fVal): ?>
                                            <div class="max-w-sm rounded-xl overflow-hidden border border-slate-200 shadow-xl group/img relative">
                                                <img src="<?php echo e($fVal); ?>" class="w-full h-auto object-cover max-h-64">
                                    ...
                                    <?php elseif($fType === 'checkbox'): ?>
                                        <div class="flex items-center gap-2">
                                            <div class="w-5 h-5 rounded-lg flex items-center justify-center <?php echo e($fVal ? 'bg-emerald-50 border border-emerald-200 text-emerald-600' : 'bg-red-50 border border-red-100 text-red-500'); ?>">
                                                <?php if($fVal): ?>
                                            ...
                                            <span class="text-xs font-bold text-slate-700"><?php echo e($fVal ? 'PASS / VERIFIED' : 'FAIL / ATTENTION REQUIRED'); ?></span>
                                        </div>

                                    <?php elseif($fType === 'multi_checkbox' || $fType === 'multi_select' || $fType === 'dropdown_multi'): ?>
                                        <div class="flex flex-wrap gap-1.5">
                                            <?php if(is_array($fVal) && count($fVal) > 0): ?>
                                                <?php $__currentLoopData = $fVal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php elseif($fVal && is_string($fVal)): ?>
                                                <span class="px-2.5 py-1 bg-slate-100 border border-slate-200 rounded-lg text-[0.58rem] font-bold text-slate-700 uppercase tracking-tighter">
                                                    <?php echo e($fVal); ?>
                                    ...
                                    <?php elseif($fType === 'radio' || $fType === 'dropdown'): ?>
                                         <?php if($fVal): ?>
                                            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-50 border border-orange-100 rounded-lg">
                                                ...
                                                <span class="text-xs font-black text-[#ff6900] uppercase"><?php echo e(is_array($fVal) ? implode(', ', $fVal) : $fVal); ?></span>
                                            </div>
                                         <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <div class="text-[0.7rem] font-bold text-[#031629] leading-relaxed">
                                            <?php echo e($fVal ?: 'No data specified'); ?>

                                        </div>
                                    <?php endif; ?>

                                    
                                    <?php if($fNotes || $fAttach): ?>
                                        <div class="mt-4 flex flex-col gap-2 border-t border-slate-50 pt-3">
                                            <?php if($fNotes): ?>
                                                <div class="text-[0.62rem] text-slate-500 italic flex items-start gap-2 bg-slate-50 p-2.5 rounded-lg border border-slate-100">
                                                    ...
                                                    <span>"<?php echo e($fNotes); ?>"</span>
                                                </div>
                                            <?php endif; ?>
                                            <?php if($fAttach): ?>
                                                <a href="<?php echo e($fAttach); ?>" target="_blank" class="inline-flex items-center gap-2 text-[0.58rem] font-black text-[#ff6900] uppercase hover:underline">
        ...
        <div class="space-y-4 sticky top-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <div class="p-5 bg-[#f0f2f5]">
                    <blockquote class="text-[0.7rem] text-slate-600 italic leading-relaxed bg-white border border-slate-200 rounded-lg px-4 py-3">
                        "<?php echo e($report->expert_summary ?? 'No summary provided by the field officer.'); ?>"
                    </blockquote>
                    ...
                    <div class="flex items-center gap-3 mt-4 bg-white border border-slate-200 rounded-lg px-4 py-3">
                        <div class="w-9 h-9 rounded-lg bg-[#1d293d] flex items-center justify-center text-white font-black text-sm flex-shrink-0">
                            <?php echo e(strtoupper(substr(optional($report->expert)->name ?? 'A', 0, 1))); ?>

                        </div>
                        <div>
                            <div class="text-[0.65rem] font-black text-[#1d293d]"><?php echo e(optional($report->expert)->name ?? 'Authorized Agent'); ?></div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <div class="divide-y divide-slate-100">
                    ...
                    <div class="flex items-center justify-between px-5 py-3">
                        <span class="text-[0.58rem] font-black uppercase tracking-widest text-slate-400"><?php echo e($key); ?></span>
                        <span class="text-[0.65rem] font-bold text-[#1d293d]"><?php echo e($value); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <?php $auction = \App\Models\Auction::where('car_id', $report->car_id)->latest()->first(); ?>
            <?php if($auction): ?>
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                <div class="px-5 py-3 bg-slate-50 border-b border-slate-200">
                ...
                <div class="p-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <?php elseif($auction->status === 'coming_soon'): ?>
                        ...
                        <span class="text-sm font-black text-slate-400 uppercase italic tracking-tighter"><?php echo e(strtoupper($auction->status)); ?></span>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/inspections/show.blade.php ENDPATH**/ ?>