            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                ...
                <div class="w-full lg:w-[55%] relative transform hover:scale-[1.05] transition-all duration-1000">
                    <img src="<?php echo e($page?->hero_image ?: '/images/cars/mclaren.png'); ?>" 
                        ...
                        alt="Elite Selection"
                        style="image-rendering: -webkit-optimize-contrast; transform: scale(<?php echo e(data_get($page?->content, 'hero.car_scale', 1)); ?>); transform-origin: center bottom;">
                </div>
                ...
                <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-8">
                    <div>
                        ...
                        <h2 class="text-3xl lg:text-4xl font-black tracking-tight flex items-center flex-wrap gap-x-3 gap-y-1">
                            <span id="wizard-title-w1" class="transition-colors duration-500 text-[#ff6900]"><?php echo e($wizardW1); ?></span>
                            <span class="text-slate-300 font-light text-2xl leading-none">&bull;</span>
                            <span id="wizard-title-w2" class="transition-colors duration-500 text-slate-300"><?php echo e($wizardW2); ?></span>
                            <span class="text-slate-300 font-light text-2xl leading-none">&bull;</span>
                            <span id="wizard-title-w3" class="transition-colors duration-500 text-slate-300"><?php echo e($wizardW3); ?></span>
                        </h2>

                    </div>

                    <p class="text-sm text-slate-500 max-w-2xl"><?php echo e(data_get($page?->content, 'lead_form.step1.subtitle', 'Pick a brand first. The model list updates automatically from the catalog.')); ?></p>
                </div>
                ...
                <div class="car-card">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex justify-between items-center border-t border-white/5 pt-6">
                            ...
                            <a href="<?php echo e(route('auctions.show', $auction)); ?>" class="w-12 h-12 rounded-md bg-[#1d293d] flex items-center justify-center text-white hover:bg-bazar-500 transition-all">
    ...
    <section class="py-24 px-6 lg:px-12 bg-white" id="live-auctions">
        <div class="mx-auto max-w-[1440px]">
            <div class="flex items-end justify-between mb-12">
                ...
                <a href="<?php echo e(route('auctions.index')); ?>" class="hidden lg:flex items-center gap-2 px-6 py-3 bg-[#1d293d] text-white rounded-xl font-black text-[0.7rem] uppercase tracking-widest hover:bg-black transition-all">
            ...
            <div class="mt-8 text-center lg:hidden">
                <a href="<?php echo e(route('auctions.index')); ?>" class="inline-flex items-center gap-2 px-8 py-4 bg-[#1d293d] text-white rounded-xl font-black text-[0.7rem] uppercase tracking-widest">
                    View All <i data-lucide="arrow-right" class="w-4 h-4 text-[#ff6900]"></i>
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\auction_app\resources\views/home.blade.php ENDPATH**/ ?>