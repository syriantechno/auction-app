                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
                            ...
                            <div class="lg:col-span-5 flex flex-col h-full space-y-5">
                                ...
                                <div class="mt-auto pt-6 space-y-4">
                                    <button type="submit" data-action="submit" class="btn-bazar-primary w-full h-14 rounded-lg font-black uppercase tracking-[0.25em] text-[0.75rem] transition-all shadow-2xl shadow-orange-500/30"><?php echo e(data_get($page?->content, 'lead_form.step3.submit_label', 'Request Free Valuation')); ?></button>
