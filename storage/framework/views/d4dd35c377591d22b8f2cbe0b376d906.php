    ...
    <section class="relative z-40 -mt-[19rem] px-6 lg:px-12 pb-16">
        <div class="mx-auto max-w-[1440px]">
            <div class="sell-wizard-card rounded-[1rem] border border-white/70 bg-white/65 backdrop-blur-2xl shadow-[0_40px_120px_-45px_rgba(15,23,42,0.35)] p-6 lg:p-8 overflow-visible">
                ...
                <form action="<?php echo e(route('sell-car-lead')); ?>" method="POST" id="sellCarWizard" data-start-step="<?php echo e($wizardStartStep); ?>" class="relative z-10">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php $__currentLoopData = $brandCardBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <button type="button" class="brand-pick group flex flex-col items-center justify-center gap-2.5 p-3 rounded-lg bg-transparent border border-transparent shadow-none transition-all duration-300 hover:shadow-none hover:bg-transparent hover:border-transparent" data-brand-pick="<?php echo e($brand['name']); ?>" data-brand-models='<?php echo json_encode($brandModels, 15, 512) ?>'>
                                            <div class="w-14 h-14 flex items-center justify-center p-0.5 transition-all duration-300 group-hover:scale-105">
                                                <img src="<?php echo e($brand['logo']); ?>" alt="<?php echo e($brand['name']); ?>" class="w-full h-full object-contain grayscale opacity-75 transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-100">
                                            </div>
                ...
                <?php $__currentLoopData = $displayBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(route('auctions.index', ['make' => $brand['name']])); ?>" class="brand-slide group">
                        <div class="brand-logo-wrapper">
                            <img src="<?php echo e($logoPath); ?>" alt="<?php echo e($brand['name']); ?>" class="brand-logo">
                        </div>
