...
<?php $__env->startSection('title', $page->title . ' - Motor Bazar'); ?>
    ...
    <section class="relative pt-32 pb-20 overflow-hidden"
        ...
        <div class="absolute inset-0 opacity-20">
            <?php if($page->hero_image): ?>
                <img src="<?php echo e($page->hero_image); ?>" alt="<?php echo e($page->title); ?>" class="w-full h-full object-cover">
            <?php endif; ?>
        </div>
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center text-white">
            ...
            <?php if($page->meta_description): ?>
                <p class="text-white/60 text-lg max-w-2xl mx-auto leading-relaxed"><?php echo e($page->meta_description); ?></p>
            <?php endif; ?>
        </div>
    </section>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-black/5 border border-slate-100 overflow-hidden">
                ...
                <div class="px-10 pt-10 pb-6 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <div class="text-xs text-slate-400 font-bold">
                        Updated <?php echo e($page->updated_at->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/page.blade.php ENDPATH**/ ?>