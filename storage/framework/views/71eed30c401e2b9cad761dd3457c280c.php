...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="message-text" style="margin-top: 12px;">
            <?php if(!empty($customBody)): ?>
                <?php echo nl2br(e(\App\Models\SystemSetting::get('email_lead_body', ''))); ?>
        ...
        <div class="summary-box">
            ...
            <div class="summary-row">
                ...
                <span class="summary-value"><?php echo e($year); ?> <?php echo e($make); ?> <?php echo e($model); ?></span>
            </div>
            <?php endif; ?>
            <?php if($date): ?>
            <div class="summary-row">
                <span class="summary-label">Inspection Date</span>
                <span class="summary-value"><?php echo e($date); ?></span>
            </div>
            <?php endif; ?>
            <?php if($time): ?>
            <div class="summary-row">
                <span class="summary-label">Inspection Time</span>
                <span class="summary-value"><?php echo e($time); ?></span>
            </div>
            <?php endif; ?>
            <div class="summary-row">
                <span class="summary-label">Inspection Type</span>
                <span class="summary-value"><?php echo e($type === 'home' ? '🏠 Home Service' : '🏢 Branch Visit'); ?></span>
            </div>
            <div class="summary-row">
                <span class="summary-label">Reference</span>
                <span class="summary-value">#<?php echo e(str_pad($lead->id, 6, '0', STR_PAD_LEFT)); ?></span>
            </div>
        </div>
        ...
        <a href="<?php echo e($siteUrl); ?>" class="cta-btn" style="color:#ffffff;">Visit Motor Bazar →</a>
    </div>
    ...
    <div class="footer">
        ...
        <p class="footer-text">
            ...
            © <?php echo e(date('Y')); ?> Motor Bazar. All rights reserved.
        </p>
    </div>
</div>
</body>
</html>
<?php /**PATH D:\auction_app\resources\views/emails/lead-confirmation.blade.php ENDPATH**/ ?>