                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="py-4 px-8">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="font-medium text-slate-700 text-sm"><?php echo e($bidUser->name ?? 'Operator'); ?></div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-8 text-[0.85rem] font-normal text-slate-600">
                                            <?php if($bidCar): ?>
                                                <?php echo e($bidCar->make); ?> <?php echo e($bidCar->model); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\auction_app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>