                ...
                <td class="py-5 px-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-10 h-10 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center p-1.5 shrink-0">
                            <?php if($finalLogo): ?>
                                <img src="<?php echo e(asset($finalLogo)); ?>" class="w-full h-full object-contain opacity-60">
                            <?php else: ?>
                                <i data-lucide="car-front" class="w-5 h-5 text-slate-300"></i>
                            <?php endif; ?>
                        </div>
                        <div class="flex flex-col">
                            <span class="text-[0.85rem] font-black text-slate-900 tracking-tighter uppercase"><?php echo e($details['make'] ?? 'Unknown'); ?></span>
                            <span class="text-[0.65rem] text-slate-500 font-bold"><?php echo e($details['year'] ?? ''); ?> <?php echo e($details['model'] ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </td>
                <td class="py-5 px-6">
