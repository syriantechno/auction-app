<?php $__env->startSection('title', $user->name . ' — Dealer Profile'); ?>
<?php $__env->startSection('page_title', 'Dealer Profile'); ?>
        ...
        <div class="px-8 pb-8">
            <div class="flex flex-col md:flex-row md:items-end gap-6 -mt-10">
                ...
                <div class="w-20 h-20 rounded-2xl bg-[#1d293d] border-4 border-white shadow-2xl flex items-center justify-center flex-shrink-0 relative z-10">
                    <span class="text-2xl font-black text-[#ff6900] uppercase italic"><?php echo e(strtoupper(substr($user->name,0,2))); ?></span>
                </div>
                ...
                <div class="flex-1 pt-2">
                    ...
                    <div class="flex flex-wrap items-center gap-4 mt-2">
                        <span class="text-[0.6rem] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                            <i data-lucide="mail" class="w-3 h-3"></i> <?php echo e($user->email); ?>

                        </span>
                        <span class="text-[0.6rem] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                            <i data-lucide="calendar" class="w-3 h-3"></i> Member since <?php echo e($user->created_at->format('M Y')); ?>

                        </span>
                        <?php if($user->phone): ?>
                        <a href="tel:<?php echo e($user->phone); ?>" class="text-[0.6rem] font-black text-[#ff6900] uppercase tracking-widest flex items-center gap-1.5 hover:underline">
                            <i data-lucide="phone" class="w-3 h-3"></i> <?php echo e($user->phone); ?>
                ...
                <a href="<?php echo e(route('admin.dealers.edit', $user)); ?>" class="h-12 px-5 bg-[#1d293d] hover:bg-[#ff6900] rounded-xl flex items-center justify-center gap-2 text-white text-[0.6rem] font-black uppercase tracking-widest shadow-lg transition-all whitespace-nowrap">
                ...
                <div class="flex items-center gap-px bg-slate-50 rounded-xl overflow-hidden border border-slate-100">
                    ...
                    <div class="px-5 py-4 text-center border-r border-slate-100 last:border-0">
                        <div class="text-lg font-black tabular-nums <?php echo e($stat['color']); ?>"><?php echo e($stat['value']); ?></div>
                        <div class="text-[0.5rem] font-black text-slate-400 uppercase tracking-widest mt-0.5 whitespace-nowrap"><?php echo e($stat['label']); ?></div>
                    </div>
    ...
    <div x-data="{ tab: 'participating' }">
        ...
        <div class="flex items-center gap-2 mb-6">
            ...
            <button @click="tab = 'won'"
                ...
                Won Auctions
                <span class="ml-1 bg-emerald-100 text-emerald-600 rounded-full px-2 py-0.5 text-[0.55rem]"><?php echo e($won->count()); ?></span>
            </button>
        </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div class="group bg-white border border-slate-100 rounded-[2rem] overflow-hidden hover:shadow-2xl hover:shadow-orange-500/5 transition-all duration-500 flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-[220px] relative overflow-hidden shrink-0 bg-[#1d293d]">
                        <img src="<?php echo e(is_string($carImage) ? (str_starts_with($carImage, 'http') ? $carImage : asset('storage/'.$carImage)) : asset('images/cars/car-silver.png')); ?>"
                    ...
                    <div class="flex-1 p-6 flex flex-col justify-between gap-5">
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div>
                                    ...
                                    <p class="text-[0.65rem] font-bold text-slate-400 mt-1.5 uppercase tracking-wide italic">
                                        <?php echo e($car?->year); ?> — <?php echo e(ucfirst($auction->status)); ?>

                                    </p>
                                </div>
                                <div class="text-right">
                                    <div class="text-[0.5rem] text-slate-400 font-black uppercase tracking-widest">My Bid</div>
                                    <div class="text-lg font-black text-[#031629] tabular-nums">$<?php echo e(number_format($auction->user_bid_amount)); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 pt-3 border-t border-slate-50">
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="text-[0.75rem] font-black <?php echo e($auction->is_leading ? 'text-emerald-600' : 'text-red-500'); ?>">
                                            $<?php echo e(number_format($auction->top_bid_amount)); ?>
                        ...
                        <div class="flex items-center gap-3">
                            <a href="<?php echo e(route('admin.auctions.show', $auction)); ?>"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div class="group bg-white border border-emerald-100 rounded-[2rem] overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-[220px] relative overflow-hidden shrink-0 bg-[#031629]">
                        <img src="<?php echo e($carImage ? (str_starts_with($carImage, 'http') ? $carImage : asset('storage/'.$carImage)) : asset('images/cars/car-silver.png')); ?>"
                    ...
                    <div class="flex-1 p-6 flex flex-col justify-between gap-5">
                        <div>
                            <div class="flex items-start justify-between mb-3">
                                <div>
                                    ...
                                    <p class="text-[0.65rem] font-bold text-slate-400 mt-1.5 uppercase tracking-wide italic"><?php echo e($car?->year); ?> Production</p>
                                </div>
                                <div class="text-right">
                            ...
                            <div class="grid grid-cols-2 gap-4 pt-3 border-t border-slate-50">
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="text-[0.72rem] font-bold text-[#031629]">
                                            <?php echo e($auction->negotiation?->updated_at?->format('d M Y') ?? 'N/A'); ?>
                                ...
                                <div class="space-y-1">
                                    ...
                                    ?>
                                    <span class="px-2 py-0.5 rounded-full text-[0.5rem] font-black uppercase tracking-widest <?php echo e($ic); ?>">
                                        <?php echo e(ucfirst($inv?->status ?? 'no invoice')); ?>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <?php if($inv): ?>
                            <a href="<?php echo e(route('admin.finance.invoice.show', $inv)); ?>"
                            ...
                            <?php else: ?>
                            <form action="<?php echo e(route('admin.finance.invoice.from-negotiation', $auction->negotiation)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/dealers/show.blade.php ENDPATH**/ ?>