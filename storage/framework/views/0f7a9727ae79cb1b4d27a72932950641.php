    ...
    <div class="px-1 mb-6">
        <div class="flex items-center gap-4">
            ...
            <div class="flex gap-3 ml-auto">
                <a href="<?php echo e(route('admin.seo.settings')); ?>" class="px-4 py-2 bg-slate-600 text-white rounded-lg font-medium hover:bg-slate-700 transition-colors">
        ...
        <div class="bg-white rounded-md border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_pages']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-md border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600"><?php echo e($stats['optimized_pages']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-md border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-600"><?php echo e($stats['indexed_pages']); ?></p>
                </div>
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
        ...
        <div class="bg-white rounded-md border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-600"><?php echo e($stats['pending_submissions']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-md border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600"><?php echo e(number_format($stats['average_score'], 1)); ?></p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100">
                        <td class="py-3 px-4 text-sm text-gray-900"><?php echo e($report['url']); ?></td>
                        <td class="py-3 px-4">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($report['score'] >= 80 ? 'bg-green-100 text-green-800' : ($report['score'] >= 60 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                                <?php echo e($report['score']); ?>

                            </span>
                        </td>
                        <td class="py-3 px-4 text-sm text-gray-600">Indexed</td>
                        <td class="py-3 px-4 text-sm text-gray-600"><?php echo e($report['date']->format('M d, Y')); ?></td>
                        <td class="py-3 px-4">
