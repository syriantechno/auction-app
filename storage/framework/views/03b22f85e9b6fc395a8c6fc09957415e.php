<?php $__env->startSection('title', 'Inspections Calendar'); ?>
<?php $__env->startSection('page_title', 'Inspections Calendar'); ?>
        ...
        <div class="col-span-12 lg:col-span-4 space-y-6">
            <div class="bg-white rounded-lg shadow-xl shadow-slate-100/50 border border-slate-100 p-8">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <span class="px-3 py-1 bg-orange-50 text-[#ff6900] text-[0.6rem] font-bold rounded-lg uppercase italic"><?php echo e(date('d M')); ?></span>
                </div>

                <div class="space-y-6 relative ml-4 border-l border-slate-100 pl-8">
                    <?php $__empty_1 = true; $__currentLoopData = $events->filter(fn($e) => \Carbon\Carbon::parse($e['start'])->isToday()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todayEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="relative group">
                        <div class="absolute -left-10 top-1.5 w-4 h-4 rounded-full border-2 border-white shadow-md transition-all group-hover:scale-125" style="background: <?php echo e($todayEvent['backgroundColor']); ?>"></div>
                        <div class="bg-slate-50 border border-slate-100 p-5 rounded-lg hover:bg-white hover:border-orange-200 hover:shadow-lg transition-all duration-300 cursor-pointer">
                            <div class="text-[0.6rem] font-black text-slate-400 uppercase tracking-widest"><?php echo e(\Carbon\Carbon::parse($todayEvent['start'])->format('h:i A')); ?></div>
                            <h5 class="text-[0.85rem] font-medium text-slate-800 italic mt-1"><?php echo e($todayEvent['title']); ?></h5>
                            <div class="flex items-center gap-2 mt-3">
                                ...
                                <span class="text-[0.65rem] text-slate-500 font-medium"><?php echo e($todayEvent['extendedProps']['inspector']); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-bold"><?php echo e(count($events)); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\auction_app\resources\views/admin/inspections/calendar.blade.php ENDPATH**/ ?>