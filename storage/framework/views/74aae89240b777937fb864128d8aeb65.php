        ...
        <div class="w-full lg:w-[55%] flex flex-col items-center justify-center relative translate-x-12 z-20 order-1 lg:order-2">
            ...
            <div class="flex items-center gap-4 mb-16 lg:-ml-24">
                <div class="w-32 h-32 flex items-center justify-center text-[#031629]">
                    <?php if($siteLogo): ?>
                        <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" class="w-20 h-20 object-contain">
                    <?php else: ?>
                        <div class="w-24 h-24 rounded-[32px] bg-[#1d293d] shadow-2xl flex items-center justify-center overflow-hidden">
                            <span class="font-black italic text-5xl text-white"><?php echo e(strtoupper(substr($siteName, 0, 1))); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                <div>
                    <h1 class="text-4xl font-black text-[#031629] uppercase italic leading-none"><?php echo e($primaryWord); ?><span class="text-bazar-500"><?php echo e($secondaryWord); ?></span></h1>
...
<?php /**PATH D:\auction_app\resources\views/auth/login.blade.php ENDPATH**/ ?>