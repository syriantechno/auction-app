                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <input type="color" name="navbar[bg_color]" value="<?php echo e(data_get($page->content, 'navbar.bg_color', '#ffffff')); ?>" class="w-10 h-10 rounded-md cursor-pointer border-0 p-0 bg-transparent">
                                                <input type="text" value="<?php echo e(data_get($page->content, 'navbar.bg_color', '#ffffff')); ?>" class="flex-1 bg-white border border-slate-200 rounded-md px-3 text-[0.7rem] font-mono text-slate-500" readonly>
                                            </div>
                                        </div>
                                        <div>
                                            <label class="text-[0.55rem] font-medium uppercase tracking-widest text-slate-500 mb-2 block">Text/Links Color</label>
                                            <div class="flex gap-2">
                                                <input type="color" name="navbar[text_color]" value="<?php echo e(data_get($page->content, 'navbar.text_color', '#1d293d')); ?>" class="w-10 h-10 rounded-md cursor-pointer border-0 p-0 bg-transparent">
                                                <input type="text" value="<?php echo e(data_get($page->content, 'navbar.text_color', '#1d293d')); ?>" class="flex-1 bg-white border border-slate-200 rounded-md px-3 text-[0.7rem] font-mono text-slate-500" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
