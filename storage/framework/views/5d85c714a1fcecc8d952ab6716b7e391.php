<?php $__env->startSection('title', 'Enterprise Overview'); ?>


<?php $__env->startSection('content'); ?>
    <div class="space-y-8 animate-in fade-in duration-500">
        <?php if(session('catalog_success')): ?>
            <div class="enterprise-card px-5 py-4 bg-emerald-50 border-emerald-100 text-emerald-600 font-medium text-sm flex items-center gap-3">
                ...
                <span><?php echo e(session('catalog_success')); ?></span>
            </div>
        <?php endif; ?>
            ...
            <div class="col-span-12 lg:col-span-4 space-y-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="enterprise-card p-6 flex flex-col">
                        ...
                        <span class="text-3xl font-medium text-slate-800 tabular-nums tracking-tighter"><?php echo e(number_format($stats['active_auctions'] ?? 0)); ?></span>
                    </div>
                    ...
                    <div class="enterprise-card p-6 flex flex-col">
                        ...
                        <span class="text-3xl font-medium text-slate-800 tabular-nums tracking-tighter"><?php echo e(number_format($stats['available_cars'] ?? 0)); ?></span>
                    </div>
                    ...
                    <div class="enterprise-card p-6 flex flex-col border-l-4 border-l-orange-500">
                        ...
                        <span class="text-3xl font-medium text-slate-800 tabular-nums tracking-tighter"><?php echo e(number_format($stats['total_bids'] ?? 0)); ?></span>
                    </div>
                    ...
                    <div class="enterprise-card p-6 flex flex-col">
                        ...
                        <span class="text-3xl font-medium text-slate-800 tabular-nums tracking-tighter"><?php echo e(number_format($stats['pending_negotiations'] ?? 0)); ?></span>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <?php $__empty_1 = true; $__currentLoopData = $recent_bids ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="py-4 px-8">
                                            <div class="flex items-center gap-4">
                                                <div class="w-9 h-9 rounded-full border border-slate-100 overflow-hidden shadow-sm">
                                                    <img src="https://i.pravatar.cc/100?u=<?php echo e($bid->user_id ?? 'default'); ?>" class="w-full h-full object-cover grayscale-[30%] hover:grayscale-0 transition-all">
                                                </div>
                                                <div class="font-medium text-slate-700 text-sm"><?php echo e(optional($bidUser)->name ?? 'Operator'); ?></div>
                                            </div>
                                        </td>
                                            ...
                                            <?php if($bidCar): ?>
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center p-1.5 shrink-0 shadow-sm">
                                                        <?php if($logo): ?>
                                                            <img src="<?php echo e($logo); ?>" class="w-full h-full object-contain opacity-70">
                                                        <?php else: ?>
                                                            <i data-lucide="car-front" class="w-4 h-4 text-slate-200"></i>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="flex flex-col leading-none">
                                                        <span class="text-sm font-black text-slate-800 tracking-tight"><?php echo e($bidCar->make); ?> <?php echo e($bidCar->model); ?></span>
                                                        <span class="text-[0.6rem] text-slate-400 font-bold uppercase mt-1">#<?php echo e($bidCar->id); ?></span>
                                                    </div>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td class="py-4 px-8 text-right text-lg font-medium text-slate-800 tracking-tighter">
                                            $<?php echo e(number_format($bid->amount ?? 0)); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>