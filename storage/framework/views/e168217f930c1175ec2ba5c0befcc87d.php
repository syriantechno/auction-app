...
<div class="elite-picker-system space-y-4">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="relative" id="timePicker">
            <input type="hidden" name="<?php echo e($timeName); ?>" id="<?php echo e($timeId); ?>">
...
(function() {
    function initElitePickers() {
        ...
        (function() {
            ...
            const hiddenVal  = document.getElementById('<?php echo e($dateId); ?>');
        ...
        (function() {
            ...
            const hiddenVal = document.getElementById('<?php echo e($timeId); ?>');
            if (!toggle || !drawer) return;
...
<?php /**PATH D:\auction_app\resources\views/components/elite-picker.blade.php ENDPATH**/ ?>