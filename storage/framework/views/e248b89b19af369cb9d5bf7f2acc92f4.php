        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                ...
                <div class="bg-white p-2 rounded-lg border border-slate-200 shadow-sm space-y-1 sticky top-4">
                    ...
                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <button type="button"
                            ...
                            <i data-lucide="<?php echo e($tab['icon']); ?>" 
                               class="w-5 h-5 flex-shrink-0 transition-colors"
                               :class="activeTab === '<?php echo e($tabId); ?>' ? '<?php echo e($c['icon']); ?>' : 'text-slate-400 group-hover:text-slate-600'"></i>
                            
                            <div class="flex-1 truncate">
                                <span x-show="sidebarOpen" x-cloak class="truncate"><?php echo e($tab['label']); ?></span>
                            </div>

                            <div x-show="activeTab === '<?php echo e($tabId); ?>'" x-cloak class="w-1.5 h-1.5 rounded-full bg-[#ff6900] shadow-[0_0_10px_rgba(255,105,0,0.4)]"></div>
                        </button>
            ...
            <div class="lg:col-span-10 space-y-4">
                    ...
                    <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <select name="site_timezone" class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/5 outline-none transition-all bg-white mb-2">
                                            <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($label === null): ?>
                                                    <option disabled class="bg-slate-50 font-black text-slate-400"><?php echo e($tz); ?></option>
                                                <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                                <?php $__currentLoopData = ['site_facebook' => 'Facebook URL', 'site_instagram' => 'Instagram URL', 'site_twitter' => 'Twitter / X URL', 'site_linkedin' => 'LinkedIn Profile']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2"><?php echo e($label); ?></label>
                                        <input type="text" name="<?php echo e($key); ?>" value="<?php echo e(old($key, $settings[$key] ?? '')); ?>" placeholder="https://..." class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                                    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center gap-3 p-3 rounded-xl border border-slate-100 bg-slate-50/50">
                                            <span class="px-2 py-0.5 text-[0.55rem] font-black uppercase rounded-md border <?php echo e($typeColors[$f['type'] ?? 'text'] ?? 'bg-slate-100 text-slate-500'); ?>"><?php echo e($f['type'] ?? 'text'); ?></span>
                                            <span class="text-[0.7rem] font-bold text-[#031629] flex-1 truncate"><?php echo e($f['label'] ?? $f['name'] ?? 'Audit Field'); ?></span>
                ...
                <div x-show="activeTab === 'tab12'" x-cloak x-transition>
                    <form action="<?php echo e(route('admin.settings.navbar.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="navbar_phone" value="<?php echo e($settings['navbar_phone'] ?? ''); ?>" placeholder="+971 4 XXX XXXX" class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-semibold focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                </div>
                                <div>
                                    <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Operating Hours</label>
                                    <input type="text" name="navbar_hours" value="<?php echo e($settings['navbar_hours'] ?? ''); ?>" placeholder="Mon–Sat 9:00 AM – 6:00 PM" class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-semibold focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                <label class="flex items-center justify-between p-4 rounded-2xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/20 transition-all cursor-pointer">
                                    ...
                                    <div class="relative">
                                        <input type="checkbox" name="navbar_sticky" value="1" class="sr-only peer" <?php echo e(($settings['navbar_sticky'] ?? '0') === '1' ? 'checked' : ''); ?>>
                                ...
                                <label class="flex items-center justify-between p-4 rounded-2xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/20 transition-all cursor-pointer">
                                    ...
                                    <div class="relative">
                                        <input type="checkbox" name="navbar_glass" value="1" class="sr-only peer" <?php echo e(($settings['navbar_glass'] ?? '0') === '1' ? 'checked' : ''); ?>>
                                        <div class="w-11 h-6 bg-slate-200 rounded-full peer peer-checked:bg-blue-500 transition-all after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-5"></div>
                                    </div>
                                </label>
                            </div>
                ...
                <div x-show="activeTab === 'tab13'" x-cloak x-transition
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden group hover:shadow-xl hover:border-amber-200 transition-all duration-500">
                                    ...
                                    <div class="px-5 py-4 bg-white border-t border-slate-50 flex items-center justify-between gap-3">
                                        <button @click="openEdit(<?php echo json_encode($company, 15, 512) ?>)" class="flex-1 px-4 py-2.5 rounded-lg border border-slate-200 text-[0.65rem] font-black text-slate-600 uppercase hover:bg-slate-800 hover:text-white hover:border-slate-800 transition-all flex items-center justify-center gap-2">
                    ...
                    <div x-show="activeTab === '<?php echo e($tabId); ?>'" x-cloak x-transition>
                        <form action="<?php echo e(route('admin.settings.lead-architecture.save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="space-y-4">
                                ...
                                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                                    ...
                                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input type="text" name="lead_header_label" value="<?php echo e($leadSettings['lead_header_label']); ?>" 
                                                class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-[#ff6900] focus:ring-4 focus:ring-orange-500/5 outline-none transition-all">
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="lead_header_title" value="<?php echo e($leadSettings['lead_header_title']); ?>" 
                                                class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-[#ff6900] focus:ring-4 focus:ring-orange-500/5 outline-none transition-all">
                                        </div>
                                        <div class="md:col-span-2">
                                            <label class="flex items-center gap-3 cursor-pointer group">
                                                <div class="relative">
                                                    <input type="checkbox" name="lead_circles_enabled" value="1" <?php echo e(($leadSettings['lead_circles_enabled'] ?? '1') === '1' ? 'checked' : ''); ?> class="sr-only peer">
                                ...
                                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                                    ...
                                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            ...
                                            <input type="text" name="lead_wizard_w1" value="<?php echo e($leadSettings['lead_wizard_w1']); ?>" 
                                                class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                        </div>
                                        <div>
                                            <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Step 2 Label</label>
                                            <input type="text" name="lead_wizard_w2" value="<?php echo e($leadSettings['lead_wizard_w2']); ?>" 
                                                class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                        </div>
                                        <div>
                                            <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Step 3 Label</label>
                                            <input type="text" name="lead_wizard_w3" value="<?php echo e($leadSettings['lead_wizard_w3']); ?>" 
                                                class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden" 
                                     x-data="{ 
                                        search: '',
                                        selected: <?php echo \Illuminate\Support\Js::from($leadSettings['lead_form_brands'])->toHtml() ?>,
                                        toggle(name) {
                                    ...
                                    <div class="p-6">
                                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 max-h-[400px] overflow-y-auto pr-2 sidebar-scroll">
                                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <template x-if="'<?php echo e(strtolower($brand->name)); ?>'.includes(search.toLowerCase())">
                                                    <label class="relative group cursor-pointer">
                                                        <input type="checkbox" name="lead_form_brands[]" value="<?php echo e($brand->name); ?>" 
                                                               class="sr-only" :checked="selected.includes('<?php echo e($brand->name); ?>')" @change="toggle('<?php echo e($brand->name); ?>')">
                                                        <div class="flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-300 h-full"
                                                             :class="selected.includes('<?php echo e($brand->name); ?>') 
                                                                ? 'border-emerald-500 bg-emerald-50/50 shadow-md shadow-emerald-500/10' 
                                                                : 'border-slate-50 bg-slate-50/50 hover:border-slate-200 hover:bg-white'">
                                                            <img src="<?php echo e($brand->logo_url); ?>" class="w-8 h-8 object-contain mb-2 filter transition-all"
                                                                 :class="selected.includes('<?php echo e($brand->name); ?>') ? 'grayscale-0' : 'grayscale group-hover:grayscale-0 opacity-40 group-hover:opacity-100'">
                                                            <span class="text-[0.6rem] font-black uppercase tracking-wider text-center"
                                                                  :class="selected.includes('<?php echo e($brand->name); ?>') ? 'text-emerald-700' : 'text-slate-400 group-hover:text-slate-900'">
                                                                <?php echo e($brand->name); ?>

                                                            </span>
                                                            <div x-show="selected.includes('<?php echo e($brand->name); ?>')" class="absolute top-2 right-2 w-4 h-4 rounded-full bg-emerald-500 flex items-center justify-center animate-in zoom-in duration-200 shadow-sm shadow-emerald-500/30">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/settings/hub.blade.php ENDPATH**/ ?>