...
<div style="display:flex;align-items:center;gap:2px;padding:5px 8px;background:#f8fafc;border-bottom:1px solid #e2e8f0;border-radius:6px 6px 0 0;flex-wrap:nowrap;">
    ...
    <label title="Text Color" onmousedown="rteSaveSelection()" style="position:relative;width:26px;height:26px;flex-shrink:0;cursor:pointer;">
        <div id="<?php echo e($rteId); ?>_fg" style="width:26px;height:26px;border-radius:4px;border:1.5px solid #e2e8f0;background:#031629;pointer-events:none;"></div>
        <input type="color" value="#031629"
            style="position:absolute;inset:0;opacity:0;width:100%;height:100%;cursor:pointer;"
            oninput="document.getElementById('<?php echo e($rteId); ?>_fg').style.background=this.value"
    ...
    <label title="Highlight" onmousedown="rteSaveSelection()" style="position:relative;width:26px;height:26px;flex-shrink:0;cursor:pointer;">
        <div id="<?php echo e($rteId); ?>_bg" style="width:26px;height:26px;border-radius:4px;border:1.5px solid #e2e8f0;background:#fef08a;pointer-events:none;"></div>
        <input type="color" value="#fef08a"
            style="position:absolute;inset:0;opacity:0;width:100%;height:100%;cursor:pointer;"
            oninput="document.getElementById('<?php echo e($rteId); ?>_bg').style.background=this.value"
...
<?php /**PATH F:\auction_app\resources\views/admin/cms/_rte_toolbar.blade.php ENDPATH**/ ?>