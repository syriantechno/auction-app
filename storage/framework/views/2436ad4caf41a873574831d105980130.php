    ...
    <nav class="<?php echo e($isSticky ? 'sticky-nav' : 'static-nav'); ?> fixed w-full z-50 px-2 lg:px-4 top-0 transition-all duration-300">
        <div class="w-full flex justify-start items-center h-24 gap-8">
            ...
            <div class="flex items-center gap-3 ml-auto">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-[0.85rem] font-bold text-deep-900 border-b-2 border-transparent hover:border-bazar-500 transition-all pb-1 hidden sm:block">Login</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="flex gap-3 flex-wrap">
                        <?php if($socialFb): ?>
                        <a href="<?php echo e($socialFb); ?>" target="_blank" class="w-9 h-9 rounded-full bg-white flex items-center justify-center hover:bg-bazar-500 hover:text-white transition-all border border-slate-200 shadow-sm" title="Facebook">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <?php endif; ?>
                        <?php if($socialIg): ?>
                        <a href="<?php echo e($socialIg); ?>" target="_blank" class="w-9 h-9 rounded-full bg-white flex items-center justify-center hover:bg-bazar-500 hover:text-white transition-all border border-slate-200 shadow-sm" title="Instagram">
                        ...
                        <?php endif; ?>
                        <?php if($socialWa): ?>
                        <a href="<?php echo e($socialWa); ?>" target="_blank" class="w-9 h-9 rounded-full bg-white flex items-center justify-center hover:bg-green-500 hover:text-white transition-all border border-slate-200 shadow-sm" title="WhatsApp">
                        ...
                        <?php endif; ?>
                        <?php if($socialYt): ?>
                        <a href="<?php echo e($socialYt); ?>" target="_blank" class="w-9 h-9 rounded-full bg-white flex items-center justify-center hover:bg-red-500 hover:text-white transition-all border border-slate-200 shadow-sm" title="YouTube">
