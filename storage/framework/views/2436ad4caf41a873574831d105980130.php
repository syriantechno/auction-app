...
<body class="font-sans">
    ...
    ?>
    <footer class="text-slate-900 pt-24 pb-12 overflow-hidden relative transition-colors duration-500" style="background-color: <?php echo e($footerColor); ?>;">
        ...
        <div class="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="<?php echo e(route('auctions.index')); ?>" class="text-slate-600 hover:text-slate-900 transition-all text-sm font-bold flex items-center gap-2 group"><i data-lucide="chevron-right" class="w-3 h-3 text-bazar-500 group-hover:translate-x-1 transition-transform"></i> Browse Auctions</a></li>
                        <li><a href="<?php echo e(route('how-it-works')); ?>" class="text-slate-600 hover:text-slate-900 transition-all text-sm font-bold flex items-center gap-2 group"><i data-lucide="chevron-right" class="w-3 h-3 text-bazar-500 group-hover:translate-x-1 transition-transform"></i> How it Works</a></li>
            ...
            <div class="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
                <p class="text-slate-500 text-xs font-bold uppercase tracking-widest leading-loose">
                    &copy; <?php echo e(date('Y')); ?> MOTOR BAZAR. ALL RIGHTS RESERVED.
                </p>
