<?php $__env->startSection('title', isset($page) ? 'Edit Page' : 'New Page'); ?>
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <div class="text-[0.55rem] font-black uppercase tracking-[0.3em] text-slate-400 mb-0.5">
                <?php echo e(isset($page) ? 'Editing' : 'Creating'); ?>
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
                    ...
                    <textarea name="content" id="pageContent" rows="18"
                              ...
                              placeholder="Write HTML or plain text content for this page..."><?php echo e(old('content', $page->content ?? '')); ?></textarea>
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="meta_description" rows="2" maxlength="320"
                                  ...
                                  placeholder="Brief description for search engines (120–160 chars recommended)"><?php echo e(old('meta_description', $page->meta_description ?? '')); ?></textarea>
                    </div>
                    <div class="space-y-2">
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
                    ...
                    <?php if(isset($existingMenuItem) && $existingMenuItem): ?>
                        <div class="flex items-center gap-3 bg-indigo-50 border border-indigo-100 rounded-xl p-3">
                            ...
                            <div class="min-w-0">
                                <div class="text-xs font-bold text-indigo-700">Linked to: <?php echo e($existingMenuItem->menu->name ?? 'Menu'); ?></div>
                                <div class="text-[0.6rem] text-indigo-400 truncate"><?php echo e($existingMenuItem->url); ?></div>
                            </div>
                        </div>
                            ...
                            <select name="add_to_menu" id="addToMenu"
                                ...
                                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($menu->id); ?>"
                                        ...
                                        <?php if($menu->location): ?> · <?php echo e($menu->location); ?> <?php endif; ?>
                                    </option>
