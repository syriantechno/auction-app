                ...
                <div class="col-span-12 md:col-span-7 space-y-6">
                    <div class="bg-slate-50 rounded-lg border border-slate-100 overflow-hidden">
                        ...
                        <div id="schedMap" class="w-full h-52 bg-slate-100 relative">
                            <?php if(\App\Models\SystemSetting::get('map_provider') == 'osm'): ?>
...
<div id="newLeadModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
    <div class="w-full max-w-2xl bg-white rounded-[2rem] shadow-2xl overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.leads.store')); ?>" method="POST" class="px-8 py-6 space-y-5 max-h-[75vh] overflow-y-auto">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="year" required placeholder="<?php echo e(date('Y')); ?>" min="1990" max="<?php echo e(date('Y') + 1); ?>"
                               class="w-full h-11 bg-slate-50 border border-slate-200 px-4 rounded-xl text-sm font-bold text-[#031629] outline-none focus:bg-white focus:border-blue-400 transition-all placeholder:text-slate-300">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <select name="source"
                            ...
                            <?php $__currentLoopData = \App\Models\Lead::getSourceOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e($val === 'direct' ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
const mapProvider = '<?php echo e(\App\Models\SystemSetting::get('map_provider', 'google')); ?>';
const googleMapsKey = '<?php echo e(\App\Models\SystemSetting::get('google_maps_api_key', '')); ?>';
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/leads/index.blade.php ENDPATH**/ ?>