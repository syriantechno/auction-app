...
<?php $__env->startSection('title', 'Motor Bazar - Premium Car Marketplace'); ?>
<?php $__env->startSection('meta_description', 'أكبر منصة لمزادات السيارات في الخليج. اشترِ سيارتك الآن بأفضل الأسعار مع تقرير فحص فني دقيق لكل سيارة.'); ?>
<?php $__env->startSection('meta_keywords', 'مزادات السيارات, سيارات مستعملة, حراج السيارات, شراء سيارة, تويوتا, نيسان, الخليج, دبي'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative z-30 overflow-visible pt-[150px] pb-72 min-h-[900px] transition-all duration-1000" 
        style="<?php echo e($backgroundStyle); ?>">
        <div class="relative z-10 mx-auto max-w-[1440px] px-6 lg:px-12 w-full flex flex-col gap-12 lg:gap-16">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                ...
                <div class="w-full lg:w-[55%] relative transform hover:scale-[1.05] transition-all duration-1000">
                    <img src="<?php echo e($page?->hero_image ?: '/images/cars/mclaren.png'); ?>" 
                        ...
                        alt="Elite Selection"
                        style="image-rendering: -webkit-optimize-contrast; transform: scale(<?php echo e($heroCarScale); ?>) <?php echo e($heroCarMirror ? 'scaleX(-1)' : ''); ?>; transform-origin: center bottom;">
                </div>
        ...
        <div class="mx-auto max-w-[1440px]">
            <div class="sell-wizard-card relative z-10 rounded-[1rem] border border-white/70 bg-white/65 backdrop-blur-2xl shadow-[0_40px_120px_-45px_rgba(15,23,42,0.35)] p-6 lg:p-8 overflow-visible">
                <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-8">
                    <div>
                        <span class="text-bazar-500 font-black uppercase tracking-[0.35em] text-[0.62rem] mb-3 block"><?php echo e($leadArchitecture['header']); ?></span>
                        <?php
                        ...
                        <h2 class="text-3xl lg:text-4xl font-black tracking-tight flex items-center flex-wrap gap-x-3 gap-y-1 text-slate-900">
                            <?php echo $leadArchitecture['wizard_title']; ?>

                        </h2>
                        <div class="flex items-center flex-wrap gap-x-3 gap-y-1 mt-4">
                            <span id="wizard-title-w1" class="text-lg font-black transition-colors duration-500 text-[#ff6900]"><?php echo e($wizardW1); ?></span>
                            <span class="text-slate-300 font-light text-2xl leading-none">&bull;</span>
                            <span id="wizard-title-w2" class="text-lg font-black transition-colors duration-500 text-slate-300"><?php echo e($wizardW2); ?></span>
                            <span class="text-slate-300 font-light text-2xl leading-none">&bull;</span>
                            <span id="wizard-title-w3" class="text-lg font-black transition-colors duration-500 text-slate-300"><?php echo e($wizardW3); ?></span>
                        </div>
                    </div>

                    <p class="text-sm text-slate-500 max-w-2xl"><?php echo e(data_get($page?->content, 'lead_form.step1.subtitle', 'The model list updates automatically from the catalog.')); ?></p>
                </div>

                <form action="<?php echo e(route('sell-car-lead')); ?>" method="POST" id="sellCarWizard" data-start-step="<?php echo e($wizardStartStep); ?>" class="relative">
                    <?php echo csrf_field(); ?>
                    ...
                    <div data-step="1" class="space-y-4">
                        ...
                        <?php if(!empty($brandCardBrands)): ?>
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
                                    <?php $__currentLoopData = $brandCardBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <button type="button" class="brand-pick group flex flex-col items-center justify-center gap-2.5 p-3 rounded-lg bg-transparent border border-transparent shadow-none transition-all duration-300 hover:shadow-none hover:bg-transparent hover:border-transparent" data-brand-pick="<?php echo e($brand['name']); ?>" data-brand-models='<?php echo json_encode($brandModels, 15, 512) ?>'>
                                            <div class="w-14 h-14 flex items-center justify-center p-0.5 transition-all duration-300 group-hover:scale-105" style="width:3.5rem;height:3.5rem;overflow:hidden;flex-shrink:0">
                                                <img src="<?php echo e($brand['logo']); ?>" alt="<?php echo e($brand['name']); ?>" class="w-full h-full object-contain grayscale opacity-75 transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-100" style="max-width:100%;max-height:100%;object-fit:contain">
                                            </div>
                                            <span class="text-[0.58rem] font-black text-slate-500 uppercase tracking-widest group-hover:text-slate-900 transition-colors text-center leading-tight"><?php echo e($brand['name']); ?></span>
                                        </button>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div class="space-y-3 relative">
                                <label class="text-[0.65rem] font-black uppercase tracking-[0.25em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step1.brand_label', 'Brand Selection')); ?></label>
                                <input type="hidden" name="make" id="sellCarMakeSelect_dynamic" value="<?php echo e(old('make')); ?>">
                                <button type="button" id="brandHubToggle" class="group w-full h-16 px-5 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-base font-black text-slate-900 shadow-sm transition-all hover:bg-slate-50">
                                    <span class="flex items-center gap-3 min-w-0">
                                        <span id="brandHubIcon" class="w-9 h-9 rounded-md bg-slate-50 border border-slate-200 flex items-center justify-center overflow-hidden <?php echo e(old('make') ? '' : 'hidden'); ?>">
                                            <img id="brandHubIconImg" src="" alt="Brand logo" class="w-full h-full object-contain p-1">
                                        </span>
                                        <span id="brandHubLabel" class="truncate <?php echo e(old('make') ? 'text-slate-900' : 'text-slate-400'); ?>"><?php echo e(old('make') ?: 'Select Brand'); ?></span>
                                    </span>
                                ...
                                <div id="brandHubDrawer" class="hidden absolute left-0 right-0 top-[calc(100%+0.75rem)] z-[9999] rounded-[1.25rem] border border-slate-200 bg-white shadow-[0_45px_130px_-25px_rgba(15,23,42,0.35)] p-5 animate-in fade-in zoom-in-95 duration-500">
                                    ...
                                    <div class="max-h-80 overflow-y-auto pt-2 pr-0.5 custom-scrollbar space-y-0">
                                        <?php $__currentLoopData = $brandSelectBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $brandKey = mb_strtolower(preg_replace('/[^a-z0-9]+/i', '', $brand['name']));
                                                $brandModels = data_get($catalogModelsByMake ?? [], $brandKey, data_get($catalogModelsByMake ?? [], '__all__', []));
                                            ?>
                                            <button type="button" class="brand-pick-final flex items-center gap-3 w-full p-1.5 rounded-[1rem] border border-transparent hover:bg-slate-50 hover:border-slate-100 transition-all text-left" data-brand-hub-value="<?php echo e($brand['name']); ?>" data-brand-hub-logo="<?php echo e($brand['logo']); ?>" data-brand-key="<?php echo e($brandKey); ?>" data-brand-models='<?php echo json_encode($brandModels, 15, 512) ?>'>
                                                ...
                                                <span class="text-sm font-semibold text-slate-700 truncate"><?php echo e($brand['name']); ?></span>
                                            </button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-3 relative">
                                <label class="text-[0.65rem] font-black uppercase tracking-[0.25em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step1.model_label', 'Model')); ?></label>
                                <input type="hidden" name="model" id="sellCarModelInput" value="<?php echo e(old('model')); ?>">
                            ...
                            <div class="space-y-3 relative">
                                <label class="text-[0.65rem] font-black uppercase tracking-[0.25em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step1.year_label', 'Year')); ?></label>
                                <input type="hidden" name="year" id="sellCarYearInput" value="<?php echo e(old('year')); ?>">
                                <button type="button" id="yearHubToggle" class="group w-full h-16 px-5 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-base font-black text-slate-900 shadow-sm transition-all hover:bg-slate-50">
                                    <span id="yearHubLabel" class="truncate <?php echo e(old('year') ? 'text-slate-900' : 'text-slate-400'); ?>"><?php echo e(old('year') ?: 'Year'); ?></span>
                                    <i data-lucide="chevron-down" class="w-5 h-5 text-slate-400 group-hover:rotate-180 transition-transform duration-500"></i>
                                </button>
                                <div id="yearHubDrawer" class="hidden absolute left-0 right-0 top-[calc(100%+0.75rem)] z-[300] rounded-[1rem] overflow-hidden border border-slate-200 bg-white/95 backdrop-blur-2xl shadow-[0_40px_120px_-30px_rgba(15,23,42,0.28)] p-2.5 animate-in fade-in zoom-in-95 duration-500">
                                    <div class="grid grid-cols-3 gap-1.5 max-h-60 overflow-y-auto pr-0.5 custom-scrollbar">
                                        <?php $__currentLoopData = $sellCarYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="year-pick p-2.5 rounded-[1rem] border border-transparent hover:bg-slate-50 hover:border-slate-100 transition-all text-center text-sm font-semibold text-slate-700 hover:text-slate-900" data-year-value="<?php echo e($year); ?>">
                                                <?php echo e($year); ?>
                        ...
                        <div class="flex justify-end pt-2">
                            <button type="button" data-action="next" class="h-16 px-12 bg-[#ff6900] text-white rounded-lg font-black uppercase tracking-widest text-sm hover:-translate-y-0.5 shadow-lg shadow-orange-500/20 transition-all group animate-pulse-orange">
                                <span class="flex items-center gap-3">
                                    <?php echo e(data_get($page?->content, 'lead_form.step1.button_label', 'Get Free Valuation')); ?>
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="space-y-1 relative">
                                    <label class="text-[0.55rem] font-black uppercase tracking-[0.2em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step2.specs_label', 'Regional Specs')); ?></label>
                                    <input type="hidden" name="gcc_specs" id="sellCarGccInput" value="<?php echo e(old('gcc_specs', 'GCC')); ?>">
                                    ...
                                    <div id="gccHubDrawer" class="hidden absolute left-0 right-0 top-full mt-1 z-[300] rounded-xl border border-slate-100 bg-white shadow-xl p-1.5">
                                        <?php $__currentLoopData = [['v'=>'GCC','l'=>'GCC Specs'],['v'=>'European','l'=>'European'],['v'=>'American','l'=>'American'],['v'=>'Canadian','l'=>'Canadian'],['v'=>'Korean','l'=>'Korean'],['v'=>'Other','l'=>'Other']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="gcc-pick block w-full px-3 py-1.5 rounded-lg text-left text-[0.7rem] font-bold text-slate-700 hover:bg-orange-50 hover:text-[#FF6900] transition-all" data-gcc-value="<?php echo e($reg['v']); ?>" data-gcc-label="<?php echo e($reg['l']); ?>"><?php echo e($reg['l']); ?></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1 relative">
                                    <label class="text-[0.55rem] font-black uppercase tracking-[0.2em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step2.body_label', 'Body Type')); ?></label>
                                    <input type="hidden" name="body_type" id="sellCarBodyInput" value="<?php echo e(old('body_type')); ?>">
                                    <button type="button" id="bodyHubToggle" class="group w-full h-9 px-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-[0.7rem] font-bold text-slate-900 transition-all hover:border-[#ff6900]/40">
                                        <span id="bodyHubLabel" class="truncate <?php echo e(old('body_type') ? 'text-slate-700' : 'text-slate-300'); ?>"><?php echo e(old('body_type') ?: 'Select Type'); ?></span>
                                    ...
                                    <div id="bodyHubDrawer" class="hidden absolute left-0 right-0 top-full mt-1 z-[300] rounded-xl border border-slate-100 bg-white shadow-xl p-1.5">
                                        <?php $__currentLoopData = ['Sedan','SUV','Coupe','Hatchback','Pickup','Luxury','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="body-pick block w-full px-3 py-1.5 rounded-lg text-left text-[0.7rem] font-bold text-slate-700 hover:bg-orange-50 hover:text-[#FF6900] transition-all" data-body-value="<?php echo e($type); ?>"><?php echo e($type); ?></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1 relative">
                                    <label class="text-[0.55rem] font-black uppercase tracking-[0.2em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step2.engine_label', 'Engine Size')); ?></label>
                                    <input type="hidden" name="engine" id="sellCarEngineInput" value="<?php echo e(old('engine')); ?>">
                                    <button type="button" id="engineHubToggle" class="group w-full h-9 px-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-[0.7rem] font-bold text-slate-900 transition-all hover:border-[#ff6900]/40">
                                        <span id="engineHubLabel" class="truncate <?php echo e(old('engine') ? 'text-slate-700' : 'text-slate-300'); ?>"><?php echo e(old('engine') ?: 'Select Engine'); ?></span>
                                        <i data-lucide="chevron-down" class="w-3.5 h-3.5 text-slate-300 shrink-0 group-hover:rotate-180 transition-transform"></i>
                                    </button>
                                    <div id="engineHubDrawer" class="hidden absolute left-0 right-0 top-full mt-1 z-[300] rounded-xl border border-slate-100 bg-white shadow-xl p-1.5">
                                        <?php $__currentLoopData = ['1.0L - 1.5L','1.6L - 2.0L','2.1L - 3.0L','3.1L - 4.0L','Over 4.0L','EV / Electric','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="engine-pick block w-full px-3 py-1.5 rounded-lg text-left text-[0.7rem] font-bold text-slate-700 hover:bg-orange-50 hover:text-[#FF6900] transition-all" data-engine-value="<?php echo e($size); ?>"><?php echo e($size); ?></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1 relative">
                                    <label class="text-[0.55rem] font-black uppercase tracking-[0.2em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step2.mileage_label', 'Mileage (KM)')); ?></label>
                                    <input type="hidden" name="mileage" id="sellCarMileageInput" value="<?php echo e(old('mileage')); ?>">
                                    <button type="button" id="mileageHubToggle" class="group w-full h-9 px-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-[0.7rem] font-bold text-slate-900 transition-all hover:border-[#ff6900]/40">
                                        <span id="mileageHubLabel" class="truncate <?php echo e(old('mileage') ? 'text-slate-700' : 'text-slate-300'); ?>"><?php echo e(old('mileage') ?: 'Select Mileage'); ?></span>
                                        <i data-lucide="chevron-down" class="w-3.5 h-3.5 text-slate-300 shrink-0 group-hover:rotate-180 transition-transform"></i>
                                    </button>
                                    <div id="mileageHubDrawer" class="hidden absolute left-0 right-0 top-full mt-1 z-[300] rounded-xl border border-slate-100 bg-white shadow-xl p-1.5">
                                        <div class="grid grid-cols-2 gap-0.5">
                                            <?php $__currentLoopData = ['0-20k','20k-50k','50k-100k','100k-150k','150k-200k','Over 200k','Unknown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button type="button" class="mileage-pick px-2 py-1.5 rounded-lg text-center text-[0.65rem] font-bold text-slate-700 hover:bg-orange-50 hover:text-[#FF6900] transition-all" data-mileage-value="<?php echo e($range); ?>"><?php echo e($range); ?></button>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-3 border-l border-slate-100 pl-5">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="hidden" name="trim" id="sellCarTrimInput" value="<?php echo e(old('trim', 'Full option')); ?>">
                                    <div class="grid grid-cols-2 gap-1.5">
                                        <?php $__currentLoopData = ['Basic','Mid option','Full option','Unknown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="trim-pick h-8 rounded-lg border border-slate-100 bg-white font-black text-[0.55rem] uppercase tracking-wide transition-all <?php echo e(old('trim','Full option') === $opt ? 'btn-active-orange' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-700'); ?>" data-trim-value="<?php echo e($opt); ?>"><?php echo e($opt); ?></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="hidden" name="paint" id="sellCarPaintInput" value="<?php echo e(old('paint', 'Original')); ?>">
                                    <div class="grid grid-cols-2 gap-1.5">
                                        <?php $__currentLoopData = ['Original','Partial','Total','Unknown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="paint-pick h-8 rounded-lg border border-slate-100 bg-white font-black text-[0.55rem] uppercase tracking-wide transition-all <?php echo e(old('paint','Original') === $opt ? 'btn-active-orange' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-700'); ?>" data-paint-value="<?php echo e($opt); ?>"><?php echo e($opt); ?></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-[0.55rem] font-black uppercase tracking-[0.2em] text-slate-400"><?php echo e(data_get($page?->content, 'lead_form.step2.condition_label', 'Overall Condition')); ?></label>
                                    <input type="hidden" name="condition" id="sellCarConditionInput" value="<?php echo e(old('condition', 'good')); ?>">
                                    <div class="grid grid-cols-2 gap-1.5">
                                        <?php $__currentLoopData = ['excellent'=>'Elite','good'=>'Good','fair'=>'Fair','needs_work'=>'Needs Work']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="condition-pick h-9 rounded-lg border-2 border-slate-100 bg-white flex items-center justify-center transition-all <?php echo e(old('condition','good') === $val ? 'btn-active-orange border-[#FF6900]' : 'text-slate-400 hover:border-[#FF6900]/20 hover:text-slate-700'); ?>" data-condition-value="<?php echo e($val); ?>">
                                                <span class="text-[0.55rem] font-black uppercase tracking-wide"><?php echo e($label); ?></span>
                                            </button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            ...
                            <div class="lg:col-span-7 space-y-5">
                                <div id="mapWrapper" class="relative h-[420px] rounded-[2rem] bg-slate-100 border-4 border-white shadow-2xl overflow-hidden group">
                                    ...
                                    <div id="googleMapCanvas" class="absolute inset-0 z-0 bg-slate-200">
                                        ...
                                        ?>
                                        <?php if($mapProvider === 'google' && $googleMapsKey): ?>
                                            <img src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo e($branchLat); ?>,<?php echo e($branchLng); ?>&zoom=14&size=800x600&scale=2&style=feature:all|element:labels|visibility:on&key=<?php echo e($googleMapsKey); ?>" class="w-full h-full object-cover grayscale opacity-50 group-hover:grayscale-0 transition-all duration-1000" alt="Map Preview">
                                        <?php else: ?>
                            ...
                            <div class="lg:col-span-5 flex flex-col h-full space-y-5">
                                ...
                                <div class="space-y-2">
                                    <label class="text-[0.6rem] font-black uppercase tracking-[0.3em] text-slate-400 flex items-center gap-1.5">
                                        ...
                                        <?php echo e(data_get($page?->content, 'lead_form.step3.slot_label', 'Appraisal Slot')); ?>
                                        ...
                                        <div class="relative" id="datePicker">
                                            ...
                                            <div id="datePickerDrawer" class="hidden absolute left-0 right-0 top-[calc(100%+0.5rem)] z-[400] rounded-2xl overflow-hidden border border-slate-100 bg-white shadow-[0_20px_60px_-15px_rgba(15,23,42,0.2)] animate-in fade-in zoom-in-95 duration-200">
                                                ...
                                                <div class="grid grid-cols-7 px-3 pt-2 pb-1">
                                                    ...
                                                    <div class="text-center text-[0.5rem] font-black uppercase text-slate-300 py-1"><?php echo e($d); ?></div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="text-[0.55rem] font-black uppercase tracking-[0.25em] text-slate-400 flex items-center gap-1">
                                            ...
                                            <?php echo e(data_get($page?->content, 'lead_form.step3.name_label', 'Full Name')); ?>
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="text-[0.55rem] font-black uppercase tracking-[0.25em] text-slate-400 flex items-center gap-1">
                                            ...
                                            <?php echo e(data_get($page?->content, 'lead_form.step3.phone_label', 'Mobile Number')); ?>
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="text-[0.55rem] font-black uppercase tracking-[0.25em] text-slate-400 flex items-center gap-1">
                                            ...
                                            <?php echo e(data_get($page?->content, 'lead_form.step3.email_label', 'Email Address')); ?>
                                ...
                                <div class="mt-auto pt-6 space-y-4">
                                    <button type="submit" data-action="submit" class="btn-bazar-primary w-full h-14 rounded-lg font-black uppercase tracking-[0.25em] text-[0.75rem] transition-all shadow-2xl shadow-orange-500/30 animate-pulse-orange"><?php echo e(data_get($page?->content, 'lead_form.step3.submit_label', 'Request Free Valuation')); ?></button>
            ...
            <div class="mt-6 mb-8 text-center">
                <h3 class="text-2xl lg:text-3xl font-black text-[#031629] tracking-tight"><?php echo e($badgesTitle); ?></h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 relative max-w-5xl mx-auto">
                ...
                <?php $__currentLoopData = $trustBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="group flex flex-col items-center text-center px-8 py-6 cursor-default">
                    ...
                    <div class="relative w-20 h-20 mb-5 flex items-center justify-center">
                        ...
                        <div class="absolute inset-0 rounded-full opacity-0 group-hover:opacity-30 transition-all duration-500 blur-xl"
                             style="background-color: <?php echo e($bColor); ?>;"></div>
                        
                        <i data-lucide="<?php echo e($bIcon); ?>" class="relative w-12 h-12 transition-all duration-300 group-hover:-translate-y-2 group-hover:scale-110"
                           style="stroke-width: 1.5; color: <?php echo e($bColor); ?>;"></i>
                    </div>

                    
                    <p class="text-[0.92rem] font-black text-[#031629] mb-2 tracking-tight"><?php echo e($bLabel); ?></p>

                    
                    <?php if($bDesc): ?>
                    <p class="text-[0.75rem] text-slate-500 font-medium leading-relaxed max-w-[200px]"><?php echo e($bDesc); ?></p>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="car-card">
                    <div class="relative h-64 overflow-hidden">
                        <img src="<?php echo e($auction->car->image_url ?? $fallbackCarImages[$loop->index % count($fallbackCarImages)]); ?>" class="w-full h-full object-cover" alt="Featured car image">
                        <div class="absolute top-5 left-5 flex flex-col gap-2">
                            <span class="badge-year"><?php echo e($auction->car->year ?? '2024'); ?></span>
                            <?php if($auction->status === 'coming_soon'): ?>
                            ...
                            <?php elseif($auction->status === 'active'): ?>
                                <div class="active-countdown bg-emerald-500 text-white text-[0.6rem] font-black px-3 py-1.5 rounded-lg uppercase tracking-widest shadow-xl shadow-emerald-500/20 flex items-center gap-2" data-end-at="<?php echo e($auction->end_at->toIso8601String()); ?>">
                    ...
                    <div class="p-8">
                        <h3 class="text-xl font-black text-slate-900 mb-2"><?php echo e($auction->car->make); ?> <?php echo e($auction->car->model); ?></h3>
                        <div class="flex items-center gap-4 text-[0.6rem] text-gray-500 font-bold uppercase tracking-widest mb-6">
                            <span><?php echo e($auction->car->transmission ?? 'Automatic'); ?></span> â€¢ <span><?php echo e($auction->car->fuel_type ?? 'Petrol'); ?></span> â€¢ <span><?php echo e($auction->car->color ?? 'Silver'); ?></span>
                        </div>
                        <div class="flex justify-between items-center border-t border-white/5 pt-6">
                            <div>
                                ...
                                <span class="text-2xl font-black text-bazar-500">$<?php echo e(number_format($auction->current_price)); ?></span>
                            </div>
                            <a href="<?php echo e(route('auctions.show', $auction)); ?>" class="w-12 h-12 rounded-md bg-[#031629] flex items-center justify-center text-white hover:bg-bazar-500 transition-all">
    ...
    <section class="py-16 px-6 lg:px-12 bg-[#e7e7e7] relative z-10">
        <div class="max-w-[1440px] mx-auto">
            ...
            <div class="text-center mb-10">
                <div class="inline-flex flex-col items-center">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <h2 class="text-lg font-black uppercase tracking-[0.25em] text-[#031629]"><?php echo e(data_get($page?->content, 'location.section_header_title', 'Find Us Section')); ?></h2>
                        <div class="h-px w-16 bg-gradient-to-l from-transparent via-[#ff4605] to-[#ff4605]"></div>
                    </div>
                    
                    <p class="text-sm text-slate-500 font-medium mt-2 tracking-wide"><?php echo e(data_get($page?->content, 'location.section_header_subtitle', 'Visit our showroom and explore premium vehicles')); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <span class="text-[0.62rem] font-black uppercase tracking-[0.3em] text-slate-500"><?php echo e(data_get($page?->content, 'location.section_label', 'Find Us')); ?></span>
            </div>
            ...
            <div class="relative rounded-3xl overflow-hidden shadow-[0_24px_80px_-20px_rgba(3,22,41,0.18)] min-h-[420px]">
                ...
                <iframe
                    src="<?php echo e(data_get($page?->content, 'location.iframe_url', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.6!2d55.296249!3d25.264171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDE1JzUxLjAiTiA1NcKwMTcnNDYuNSJF!5e0!3m2!1sen!2sae!4v1680000000000!5m2!1sen!2sae')); ?>"
                ...
                <div class="relative z-10 flex flex-col justify-center h-full min-h-[420px] max-w-sm px-10 py-10">
                    ...
                    <h2 class="text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight mb-2">
                        <?php echo e(data_get($page?->content, 'location.title', 'Visit Motor')); ?><br><span class="text-[#ff4605]"><?php echo e(data_get($page?->content, 'location.title_accent', 'Bazar')); ?></span>
                    </h2>
                    <p class="text-slate-300 text-sm font-medium mb-8"><?php echo e(data_get($page?->content, 'location.subtitle', 'Come see our full inventory in person — our team is ready to help.')); ?></p>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-white"><?php echo e(data_get($page?->content, 'location.address', 'Dubai, United Arab Emirates')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-white"><?php echo e(data_get($page?->content, 'location.phone', '+971 4 000 0000')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-white"><?php echo e(data_get($page?->content, 'location.hours', 'Mon – Sat: 9:00 AM – 7:00 PM')); ?></p>
                            </div>
                        </div>
                    </div>

                    <a href="<?php echo e(data_get($page?->content, 'location.maps_url', 'https://maps.google.com')); ?>"
                       target="_blank"
                       class="inline-flex items-center gap-2.5 bg-[#ff4605] hover:bg-[#ff6900] text-white font-black text-[0.72rem] uppercase tracking-[0.2em] px-6 py-3.5 rounded-xl transition-all duration-300 hover:shadow-[0_8px_24px_-6px_rgba(255,70,5,0.5)] hover:-translate-y-0.5 w-fit">
                        ...
                        <?php echo e(data_get($page?->content, 'location.button_label', 'Get Directions')); ?>
    ...
    <section class="py-20 px-6 lg:px-12 bg-transparent relative z-10">
        <div class="max-w-[1440px] mx-auto">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-8">
                ...
                <a href="<?php echo e(route('auctions.index')); ?>" class="text-deep-900 font-black text-xs uppercase tracking-[0.22em] border-b-2 border-bazar-500 pb-1 w-fit">View all inventory</a>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6" id="body-types-container">
                ...
                <div class="body-type-card" onclick="window.location.href='<?php echo e(route('auctions.index', ['body_type' => $type['slug']])); ?>'">
                    <i data-lucide="<?php echo e($type['icon'] ?? 'car'); ?>" class="w-10 h-10 mx-auto mb-4 text-bazar-500"></i>
                    <span class="text-sm font-black uppercase tracking-widest text-deep-900"><?php echo e($type['label']); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <section class="py-16 bg-transparent relative overflow-hidden z-10">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-12 mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('auctions.index')); ?>" class="text-gray-600 hover:text-deep-900 font-bold text-xs uppercase tracking-widest border-b border-gray-400 pb-1 transition-colors">View All</a>
            </div>
        </div>
        ...
        <div class="brands-carousel-container relative">
            <div class="brands-track" id="brands-track">
                <?php $__currentLoopData = $displayBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo e(route('auctions.index', ['make' => $brand['name']])); ?>" class="brand-slide group">
                        <div class="brand-logo-wrapper" style="width:60px;height:60px;overflow:hidden;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                            <img src="<?php echo e($logoPath); ?>" alt="<?php echo e($brand['name']); ?>" class="brand-logo" style="max-width:100%;max-height:100%;object-fit:contain;filter:grayscale(100%) opacity(0.6)">
                        </div>
    ...
    <section class="py-24 px-6 lg:px-12 bg-white" id="live-auctions">
        <div class="mx-auto max-w-[1440px]">
            <div class="flex items-end justify-between mb-12">
                ...
                <a href="<?php echo e(route('auctions.index')); ?>" class="hidden lg:flex items-center gap-2 px-6 py-3 bg-[#031629] text-white rounded-xl font-black text-[0.7rem] uppercase tracking-widest hover:bg-black transition-all">
                    View All <i data-lucide="arrow-right" class="w-4 h-4 text-[#ff6900]"></i>
                </a>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $featuredAuctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <a href="<?php echo e(route('auctions.show', $fa)); ?>" class="group block bg-white rounded-[2rem] overflow-hidden border border-slate-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                    <div class="relative h-56 bg-slate-50 overflow-hidden">
                        <img src="<?php echo e($faImageUrl); ?>" alt="<?php echo e(optional($fa->car)->make); ?> <?php echo e(optional($fa->car)->model); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="px-3 py-1.5 bg-[#031629]/90 text-white rounded-full text-[0.6rem] font-black tracking-widest backdrop-blur-sm">
                                <?php echo e($fa->bids_count); ?> Bids
                            </span>
                        </div>
                    </div>
                    <div class="p-6">
                        <div class="text-[0.6rem] font-black uppercase tracking-widest text-slate-400 mb-1">
                            <?php echo e(optional($fa->car)->year); ?> · Ref: <?php echo e($fa->reference_code); ?>

                        </div>
                        <h3 class="text-xl font-black text-[#031629] tracking-tight leading-tight mb-4">
                            <?php echo e(optional($fa->car)->make); ?> <?php echo e(optional($fa->car)->model); ?>

                        </h3>
                        <div class="flex items-end justify-between">
                            <div>
                                <div class="text-[0.6rem] font-black uppercase text-slate-400 tracking-widest mb-1"><?php echo e($isLive ? 'Current Bid' : 'Starting Price'); ?></div>
                                <div class="text-2xl font-black text-[#031629]">$<?php echo e(number_format($faPrice, 0)); ?></div>
                            </div>
                            <div class="text-right">
                                <div class="text-[0.6rem] font-black uppercase text-slate-400 tracking-widest mb-1"><?php echo e($isLive ? 'Ends In' : 'Opens In'); ?></div>
                                <div class="text-sm font-black text-[#ff6900] tabular-nums auction-timer"
                                     data-expires="<?php echo e($isLive ? $fa->end_at?->toIso8601String() : $fa->start_at?->toIso8601String()); ?>">--:--:--</div>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-slate-50 flex items-center justify-between">
                            <span class="text-[0.6rem] font-black text-slate-400 uppercase tracking-widest">+$<?php echo e(number_format($fa->bid_increment ?? 500, 0)); ?> increment</span>
                            <span class="flex items-center gap-1 text-[0.65rem] font-black text-[#ff6900] uppercase tracking-widest group-hover:gap-2 transition-all">
                                <?php echo e($isLive ? 'Bid Now' : 'View Details'); ?> <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                            </span>
                        </div>
                    </div>
                </a>
            ...
            <div class="mt-8 text-center lg:hidden">
                <a href="<?php echo e(route('auctions.index')); ?>" class="inline-flex items-center gap-2 px-8 py-4 bg-[#031629] text-white rounded-xl font-black text-[0.7rem] uppercase tracking-widest">
                    View All <i data-lucide="arrow-right" class="w-4 h-4 text-[#ff6900]"></i>
                </a>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const branchLat = <?php echo e(\App\Models\SystemSetting::get('branch_lat', '25.1384')); ?>;
            const branchLng = <?php echo e(\App\Models\SystemSetting::get('branch_lng', '55.2285')); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/home.blade.php ENDPATH**/ ?>