...
<div class="px-2 space-y-8 pb-20">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 pb-10 border-b border-slate-100">
        ...
        <div class="flex items-center gap-10">
            ...
            <div class="flex items-baseline gap-3">
                <span class="text-3xl font-black text-[#ff6900] tabular-nums tracking-tighter"><?php echo e($tasks->filter(fn ($t) => (($t->car_details ?? [])['inspection_date'] ?? '') === date('Y-m-d'))->count()); ?></span>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\auction_app\resources\views/admin/inspections/tasks.blade.php ENDPATH**/ ?>