...
return new class extends Migration
{
    public function up()
    {
        // Check if table exists with wrong name and rename it
        if (Schema::hasTable('s_e_o_settings')) {
            Schema::rename('s_e_o_settings', 'seo_settings');
        }
        
        // Ensure the table exists with correct name
