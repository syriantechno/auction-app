...
@section('meta_description', 'The page you are looking for does not exist on Motor Bazar.')
...
<div class="min-h-screen flex items-center justify-center pt-24 pb-20 px-6">
    <div class="max-w-4xl w-full text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            <a href="{{ route('auctions.index') }}" class="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
            ...
            <a href="{{ route('blog.index') }}" class="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
