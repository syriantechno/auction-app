...
<x-admin-page-standard 
    ...
    title="Settings" 
    highlight="Hub" 
    subtitle="Global system configuration center"
    dot="orange">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white p-2 rounded-lg border border-slate-200 shadow-sm space-y-1 sticky top-4">
                ...
                $tabs = [
                    ...
                    14 => ['label' => 'Google Reviews', 'sub' => 'Social Proof',   'color' => 'emerald'],
        ...
        <div class="lg:col-span-10 space-y-4">
            ...
            <div x-show="activeTab === 'tab14'" x-cloak x-transition
                x-data="{
                    reviews: @js($googleReviewSettings['manual_reviews']),
                    addReview() {
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <label class="inline-flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" name="google_reviews_enabled" value="1" class="sr-only" {{ $googleReviewSettings['enabled'] === '1' ? 'checked' : '' }}>
                                <div class="w-11 h-6 rounded-full bg-slate-200 peer peer-checked:bg-emerald-500 transition-all relative">
                                    <div class="absolute top-1 left-1 h-4 w-4 rounded-full bg-white shadow peer-checked:translate-x-5 transition-all"></div>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="google_reviews_title" value="{{ old('google_reviews_title', $googleReviewSettings['title']) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 text-sm font-semibold">
                            </div>
                            <div>
                                <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Sub-heading</label>
                                <input type="text" name="google_reviews_subtitle" value="{{ old('google_reviews_subtitle', $googleReviewSettings['subtitle']) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 text-sm font-semibold">
                            </div>
                            <div>
                                <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Badge text</label>
                                <input type="text" name="google_reviews_badge" value="{{ old('google_reviews_badge', $googleReviewSettings['badge']) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 text-sm font-semibold" placeholder="e.g. 4.9 / 5 • Google Reviews">
                            </div>
                            <div>
                                <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Google Place ID</label>
                                <input type="text" name="google_reviews_place_id" value="{{ old('google_reviews_place_id', $googleReviewSettings['place_id']) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 text-sm font-semibold" placeholder="ChIJ...">
                            ...
                            <div>
                                ...
                                <input type="text" name="google_reviews_api_key" value="{{ old('google_reviews_api_key', $googleReviewSettings['api_key']) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/10 text-sm font-mono" placeholder="AIza...">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <button type="submit" class="px-8 py-3 rounded-xl bg-[#031629] text-white text-[0.7rem] font-black uppercase tracking-[0.3em] shadow-lg shadow-slate-900/20 hover:bg-emerald-600 transition-all">
                                Save Google Reviews
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden group hover:shadow-xl hover:border-amber-200 transition-all duration-500">
                            ...
                            <div class="px-5 py-4 bg-white border-t border-slate-50 flex items-center justify-between gap-3">
                                <button @click="openEdit({{ $company->toJson() }})" class="flex-1 px-4 py-2.5 rounded-lg border border-slate-200 text-[0.65rem] font-black text-slate-600 uppercase hover:bg-slate-800 hover:text-white hover:border-slate-800 transition-all flex items-center justify-center gap-2">
            ...
            @foreach($tabs as $num => $tab)
            @if($num <= 9 || $num == 11 || $num == 13) @continue @endif
