                    ...
                    <div class="space-y-5">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                            ...
                            <div class="p-6 space-y-4">
                                <div>
                                    <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Map Provider</label>
                                    <select name="map_provider" class="w-full px-4 py-3 text-sm font-semibold border border-slate-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all">
                                        <option value="google" {{ \App\Models\SystemSetting::get('map_provider') == 'google' ? 'selected' : '' }}>Google Maps</option>
                                        <option value="osm" {{ \App\Models\SystemSetting::get('map_provider') == 'osm' ? 'selected' : '' }}>OpenStreetMap (Free)</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-[0.6rem] font-black uppercase tracking-widest text-slate-500 mb-2">Google Maps API Key</label>
