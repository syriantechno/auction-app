...
@section('page_title', 'Inspection Field Builder')
...
@section('content')
    <x-admin-page-standard title="Inspection Field Builder">
        ...
        <div class="max-w-[1600px] mx-auto" x-data='inspectionFieldBuilder(@json($sections))'>
            ...
            <form id="inspection-fields-form" action="{{ route('admin.settings.inspection-fields.update') }}" method="POST">
                @csrf
