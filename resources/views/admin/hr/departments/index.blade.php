...
<div x-data="departmentManager()" x-init="initComponent()">
    <x-admin-page-standard 
        ...
        title="Department" 
        highlight="Manager" 
        subtitle="Organize and manage your company departments efficiently"
        dot="emerald">
        ...
        <x-admin-data-view 
            alpine 
            alpineCount="departments.length" 
            emptyTitle="No Units Defined" 
            emptySubtitle="The organizational map is currently empty. Initialize your first node to begin hierarchy mapping." 
            emptyIcon="layers">
    ...
    <x-admin-modal x-show="opened" title="Department Details" icon="layers" size="max-w-4xl">
        <div class="col-span-12 grid grid-cols-12 gap-0 overflow-hidden rounded-2xl">
            ...
            <div class="col-span-12 lg:col-span-5 p-10 space-y-8 bg-slate-50/50 border-r border-slate-200">
                ...
                <div class="space-y-6 pt-4">
                    <x-elite-select label="Department Manager" icon="user-check" x-model="form.manager_id">
            ...
            <div class="col-span-12 lg:col-span-7 p-10 space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <x-elite-select label="Company" icon="building" x-model="form.company_id" required>
                    ...
                    <x-elite-select label="Parent Department" icon="layers" x-model="form.parent_id">
...
<script>
    function departmentManager() {
        return {
            ...
            allDepartments: @json($parentDepartments),
            ...
            async fetchData() {
                let url = `{{ route('admin.hr.departments.index') }}?search=${this.search}`;
