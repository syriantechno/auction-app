                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="col-span-2 grid grid-cols-2 gap-4 pt-2">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <input type="range" name="hero_car_top" min="0" max="100" step="1" value="{{ old('hero_car_top', data_get($page->content, 'hero.car_top', 80)) }}" class="w-full">
                                        <div class="flex justify-between text-[0.45rem] font-bold text-slate-400">
                                            <span>Top</span>
                                            <span class="text-blue-600">{{ data_get($page->content, 'hero.car_top', 80) }}%</span>
                                            <span>Bottom</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div>
                                                ...
                                                <input type="text" name="location[title]" value="{{ old('location.title', data_get($page->content, 'location.title', 'Visit Motor')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-slate-700 focus:border-[#ff6900] outline-none transition-all" placeholder="Visit Motor">
                                            </div>
                                            <div>
                                                <label class="text-[0.55rem] font-medium uppercase tracking-widest text-slate-500 mb-2 block">Title Accent (Orange)</label>
                                                <input type="text" name="location[title_accent]" value="{{ old('location.title_accent', data_get($page->content, 'location.title_accent', 'Bazar')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-[#ff6900] focus:border-[#ff6900] outline-none transition-all" placeholder="Bazar">
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-slate-50 p-5 rounded-lg border border-slate-100 grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="location[button_label]" value="{{ old('location.button_label', data_get($page->content, 'location.button_label', 'Get Directions')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-slate-700 focus:border-[#ff6900] outline-none transition-all">
                                        </div>
                                        <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="location[address]" value="{{ old('location.address', data_get($page->content, 'location.address', 'Dubai, United Arab Emirates')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-slate-700 outline-none focus:border-[#ff6900]">
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="location[phone]" value="{{ old('location.phone', data_get($page->content, 'location.phone', '+971 4 000 0000')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-slate-700 outline-none focus:border-[#ff6900]">
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="location[hours]" value="{{ old('location.hours', data_get($page->content, 'location.hours', 'Mon – Sat: 9:00 AM – 7:00 PM')) }}" class="w-full bg-white border border-slate-200 rounded-md px-4 py-2.5 text-[0.8rem] font-bold text-slate-700 outline-none focus:border-[#ff6900]">
                                        </div>
                                    </div>
                                </div>
