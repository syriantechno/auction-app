...
<head>
    ...
    <style>
        ...
        .sc-btn-shining {
            ...
            position: relative;
            overflow: hidden;
            box-shadow: 0 10px 25px rgba(255, 105, 0, 0.4) !important;
            transition: all 0.3s ease;
        }

        .sc-btn-shining:hover {
            transform: translateY(-2px);
            box-shadow: 0 15px 35px rgba(255, 105, 0, 0.5) !important;
        }

        .sc-btn-shining::after {
            content: "";
            position: absolute;
            top: -50%;
            left: -50%;
...
<body x-data>
    ...
    <main>
        <section class="hero">
                ...
                @if($lfShowHero)
                    <div class="hero-form-col">
                        ...
                        <div class="search-card" x-cloak x-data="{
                            ...
                            <div class="sc-body" x-show="heroWizardTab==='car'"
                                ...
                                <div x-show="heroWizardStep === 1">
                                    ...
                                    <div class="flex justify-end pt-5 relative">
                                        ...
                                        <button type="button" class="sc-btn-shining w-full mt-4"
                                            style="height:54px; border-radius:14px; font-weight:1000; font-size:0.9rem"
                                            @click="if(make && model && year) { heroWizardStep=2 } else { triggerToast('Please select Brand, Model and Year first!') }">
                                            GET FREE VALUATION &rarr;
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div x-show="heroWizardStep === 2">
                                            ...
                                            <div>
                                                ...
                                                <div class="sc-field mt-1" style="height:52px; background:#f8fafc; border-radius:1rem;">
                                                    <select x-model="body" class="wiz-input-sm w-full h-full bg-transparent border-none outline-none px-4 font-bold text-[#031629]">
                                                        ...
                                                        <option>Soft top convertible</option>
                                                        <option>Wagon</option>
                                            ...
                                            <div>
                                                ...
                                                <div class="sc-field mt-1" style="height:52px; background:#f8fafc; border-radius:1rem;">
                                                    <select x-model="engine" class="wiz-input-sm w-full h-full bg-transparent border-none outline-none px-4 font-bold text-[#031629]">
                                                        ...
                                                        @foreach(['1.0L','1.2L','1.4L','1.6L','1.8L','2.0L','2.2L','2.4L','2.5L','3.0L','3.5L','3.8L','4.0L','4.4L','4.8L','5.0L','5.5L','6.0L','Other'] as $eng)
                                                            <option>{{ $eng }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="sc-field mt-1" style="height:52px; background:#f8fafc; border-radius:1rem;">
                                                    <select x-model="mileage" class="wiz-input-sm w-full h-full bg-transparent border-none outline-none px-4 font-bold text-[#031629]">
                                                        ...
                                                        @foreach(['Up to 5,000 KM','Up to 10,000 KM','Up to 20,000 KM','Up to 30,000 KM','Up to 40,000 KM','Up to 60,000 KM','Up to 80,000 KM','Up to 100,000 KM','Up to 125,000 KM','Up to 150,000 KM','Up to 175,000 KM','Up to 200,000 KM','Up to 225,000 KM','Up to 250,000 KM','More than 250,000 KM','Don\'t know, assume normal usage'] as $mile)
                                                            <option>{{ $mile }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="sc-field mt-1" style="height:52px; background:#f8fafc; border-radius:1rem;">
                                                    <select x-model="gcc" class="wiz-input-sm w-full h-full bg-transparent border-none outline-none px-4 font-bold text-[#031629]">
                                                        ...
                                                        <option>GCC Specs</option>
                                                        <option>American Specs</option>
                                                        <option>Japanese Specs</option>
                                                        <option>Korean Specs</option>
                                                        <option>Canadian Specs</option>
                                        ...
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <div class="grid grid-cols-2 gap-2 mt-1">
                                                    <template x-for="opt in ['Basic','Mid','Full','Unknown']">
                                                        <button type="button" @click="trim=opt"
                                                            ...
                                                            x-text="opt === 'Unknown' ? 'I don\'t know' : opt + ' option'">
                                                        </button>
                                                    </template>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="grid grid-cols-2 gap-2 mt-1">
                                                    <template x-for="p in ['Original Paint','1-2 Panels Repaint','3+ Panels Repaint','Major Accident Repaint','Total Repaint','Unknown']">
                                    ...
                                    <div class="flex justify-between items-center pt-8 border-t border-slate-100 mt-6">
                                        ...
                                        <button type="button" class="sc-btn" style="flex:1; margin-left:10px"
                                            @click="heroWizardStep=3">
                                            CONTINUE TO VALUATION &rarr;
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div x-show="heroWizardStep === 3" x-cloak>
                                    ...
                                    <div class="grid grid-cols-2 gap-3 mb-6" style="margin-top:30px;">
                                        <div class="col-span-2">
                                            <div class="sc-field" style="height:52px; background:#f8fafc;">
                                                <input type="text" x-model="name" placeholder="{{ $lfNameLabel }}" class="w-full h-full bg-transparent border-none outline-none text-[0.85rem] font-bold text-[#031629] px-6">
                                            </div>
                                        </div>
                                        <div class="sc-field" style="height:52px; background:#f8fafc;">
                                            <input type="tel" x-model="phone" placeholder="{{ $lfPhoneLabel }}" class="w-full h-full bg-transparent border-none outline-none text-[0.85rem] font-bold text-[#031629] px-6">
                                        </div>
                                        <div class="sc-field" style="height:52px; background:#f8fafc;">
                                    ...
                                    <div style="display:flex; gap:10px; margin-top:20px;">
                                        ...
                                        <button type="button" class="sc-btn flex-1" @click="if(name && phone && email) $refs.carForm.submit()">
                                            COMPLETE REQUEST &rarr;
                                        </button>
                                    </div>
                                </div>
                            ...
                            {{-- ── PLATE TAB ── --}}
                            <div class="sc-body" x-show="heroWizardTab==='plate'"
                                ...
                                <div x-show="heroWizardStep===1">
                                    <p class="sc-label" style="color:#94a3b8; margin-bottom:8px">Plate Details</p>
                                    <div
                                    ...
                                    <p class="sc-label" style="color:#94a3b8; margin-bottom:8px">Select Emirate</p>
                                    <div class="sc-emirate-grid">
                                        @foreach(['Dubai', 'Abu Dhabi', 'Sharjah', 'Ajman', 'RAK', 'UAQ', 'Fujairah'] as $em)
                                            <button type="button" class="sc-emirate-btn"
                                                :class="emirate==='{{ $em }}' ? 'picked' : ''"
                                                @click="emirate='{{ $em }}'; plateCode = availableCodes[0]">{{ $em }}</button>
                                        @endforeach
                                    </div>

                                    <button type="button" class="sc-btn" @click="if(plate) heroWizardStep=2"
                                        :disabled="!plate">
                                        Next Step
                                ...
                                <div x-show="heroWizardStep===2" style="display:none">
                                    ...
                                    <div class="sc-field">
                                        <svg class="sc-field-icon" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <div class="sc-field">
                                        <img src="/images/icons/uae-flag.svg" style="width:16px; opacity:0.6" alt="">
                                    ...
                                    <div class="sc-field">
                                        <svg class="sc-field-icon" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L4.82 8.909a2.25 2.25 0 01-1.07-1.916V6.75" />
                                        </svg>
                                    ...
                                    <form action="{{ route('sell-car-lead') }}" method="POST" x-ref="plateForm">
                                        ...
                                        <input type="hidden" name="phone" :value="phone">
                                        <input type="hidden" name="email" :value="email">
                                        <input type="hidden" name="inspection_type" x-ref="inspTypePlate" value="branch">
                                        <input type="hidden" name="inspection_date"
                                            value="{{ now()->addDays(2)->format('Y-m-d') }}">
                                        <input type="hidden" name="inspection_time" value="10:00">
                                        <input type="hidden" name="lead_type" value="sell_plate">
                                    </form>

                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin: 16px 0;">
                                        <button type="button" @click="$refs.inspTypePlate.value='branch'"
                                            class="flex flex-col items-center justify-center gap-1 border-2 rounded-[0.75rem] transition-all p-3"
                                            style="min-height: 70px;"
                                            :style="$refs.inspTypePlate && $refs.inspTypePlate.value === 'branch' ? 'border-color:#ff6900; background:#fff7f0; color:#ff6900;' : 'border-color:#eef2f6; background:#f8fafc; color:#94a3b8;'">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 0 0 3.75-3.658V4.25a.75.75 0 0 1 .75-.75h1.125a.75.75 0 0 1 .75.75v1.442a3 3 0 0 0 4.072 2.712M4.347 18.651a.75.75 0 0 1 0-1.5H5m13.31 0a.75.75 0 0 0 0-1.5H18" />
                                            </svg>
                                            <span
                                                style="font-size: 0.65rem; font-weight: 950; text-transform: uppercase;">Hub
                                                Branch</span>
                                        </button>
                                        <button type="button" @click="$refs.inspTypePlate.value='home'"
                                            class="flex flex-col items-center justify-center gap-1 border-2 rounded-[0.75rem] transition-all p-3"
                                            style="min-height: 70px;"
                                            :style="$refs.inspTypePlate && $refs.inspTypePlate.value === 'home' ? 'border-color:#ff6900; background:#fff7f0; color:#ff6900;' : 'border-color:#eef2f6; background:#f8fafc; color:#94a3b8;'">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                            ...
                                            <span
                                                style="font-size: 0.65rem; font-weight: 950; text-transform: uppercase;">Home
                                                Service</span>
                                        </button>
                                    </div>
                                    ...
                                    <div style="display:flex; gap:10px;">
                                        ...
                                        <button type="button" class="sc-btn w-full" style="flex:1"
                                            @click="if(plate && name && phone && email) $refs.plateForm.submit()"
                                            :disabled="!(plate && name && phone && email)">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"
                                                viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- Relocated Trust Badges Section (Outside hero-inner, centered) --}}
            <div class="sc-pill-container">
                <div class="sc-pill-stats">
                    @foreach($formattedBadges as $index => $badge)
                        <div class="sc-pill-item">
                            <div class="sc-pill-icon" style="background: {{ $badge['bg'] }}; color: {{ $badge['color'] }};">
                                <div class="sc-pill-icon-glow" style="background: {{ $badge['color'] }};"></div>
                                <i data-lucide="{{ $badge['icon'] }}" style="stroke-width: 2.5px;"></i>
                            </div>
                            <div class="sc-pill-content">
                                <span class="sc-pill-label">{{ $badge['main'] }}</span>
                                @if($badge['sub'])
                                    <span class="sc-pill-val">{{ $badge['sub'] }}</span>
                                @endif
                                @if($badge['desc'])
                                    <span class="sc-pill-desc">{{ $badge['desc'] }}</span>
                                @endif
                            </div>
                        </div>
                        @if(!$loop->last)
    ...
    <section style="background:#f0f2f5;padding:0 80px 36px">
        <div style="max-width:1200px;margin:0 auto">
            <div
                ...
                {{-- Form --}}
                <form action="{{ route('sell-car-lead') }}" method="POST" x-data="{
                    allModels: {{ Js::from($catalogModelsByMake ?? []) }},
                    brand: '',
                    models: [],
                        ...
                        <div>
                            ...
                            <div style="position:relative">
                                <select name="budget"
                                    ...
                                    @foreach(['Under 30k AED', '30k – 60k AED', '60k – 100k AED', '100k – 150k AED', '150k – 250k AED', 'Over 250k AED'] as $b)
    ...
    <section class="wiz-section" id="sellSection">
        <div style="max-width:1200px;margin:0 auto">
            ...
            <div class="wiz-header">
                <p class="wiz-eyebrow">{{ $leadArchitecture['header'] }}</p>
                <div class="wiz-title">
                    <span class="step-word active" id="h2w1">{{ $leadArchitecture['step1'] }}</span>
                    <span class="sep">&bull;</span>
                    <span class="step-word muted" id="h2w2">{{ $leadArchitecture['step2'] }}</span>
                    <span class="sep">&bull;</span>
                    <span class="step-word muted" id="h2w3">{{ $leadArchitecture['step3'] }}</span>
                </div>
            </div>
            ...
            <div class="wiz-card" id="h2wizCard">
                <form action="{{ route('sell-car-lead') }}" method="POST" id="h2wizard"
                    data-start-step="{{ $wizardStartStep2 }}">
                    @csrf

                    {{-- ════ STEP 1: Brand / Model / Year ════ --}}
                    <div data-step="1" class="wiz-step active">

                        {{-- Quick pick brand cards --}}
                        @if(!empty($brandCardBrands2))
                            <div style="margin-bottom:16px">
                                <span class="field-lbl">Popular Brands</span>
                                <div class="brand-grid">
                                    @foreach($brandCardBrands2 as $brand)
                                        @php
                                        ...
                                        @endphp
                                        <button type="button" class="brand-card" data-brand-pick="{{ $brand['name'] }}"
                                            data-brand-models='@json($bModels2)'>
                                        ...
                                        <div class="hub-list">
                                            @foreach($brandSelectBrands2 as $brand)
                                                ...
                                                <button type="button" class="hub-option"
                                                    data-brand-hub-value="{{ $brand['name'] }}"
                                                    data-brand-hub-logo="{{ $brand['logo'] }}"
                                                    data-brand-key="{{ $bKey2b }}" data-brand-models='@json($bModels2b)'>
                                                    <img src="{{ $brand['logo'] }}" alt="{{ $brand['name'] }}"
                            ...
                            <div>
                                ...
                                <div class="field-wrap">
                                    ...
                                    <div class="hub-drawer" id="h2yearDrawer">
                                        <div class="hub-grid3">
                                            @foreach($sellCarYears2 as $yr)
                                                <button type="button" class="h2year-pick hub-option"
                                                    data-year-value="{{ $yr }}"
                                                    style="justify-content:center">{{ $yr }}</button>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:28px">
                                        ...
                                        <div class="hub-drawer" id="h2gccDrawer">
                                            @foreach([['v' => 'GCC', 'l' => 'GCC Specs'], ['v' => 'European', 'l' => 'European'], ['v' => 'American', 'l' => 'American'], ['v' => 'Canadian', 'l' => 'Canadian'], ['v' => 'Korean', 'l' => 'Korean'], ['v' => 'Other', 'l' => 'Other']] as $reg)
                                                <button type="button" class="h2gcc-pick hub-option"
                                                    data-gcc-value="{{ $reg['v'] }}"
                                                    data-gcc-label="{{ $reg['l'] }}">{{ $reg['l'] }}</button>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="hub-drawer" id="h2bodyDrawer">
                                            @foreach(['Sedan', 'SUV', 'Coupe', 'Hatchback', 'Pickup', 'Luxury', 'Other'] as $type)
                                                <button type="button" class="h2body-pick hub-option"
                                                    data-body-value="{{ $type }}">{{ $type }}</button>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="field-wrap">
                                        ...
                                        <div class="hub-drawer" id="h2engineDrawer">
                                            @foreach(['1.0L - 1.5L', '1.6L - 2.0L', '2.1L - 3.0L', '3.1L - 4.0L', 'Over 4.0L', 'EV / Electric', 'Other'] as $sz)
                                                <button type="button" class="h2engine-pick hub-option"
                                                    data-engine-value="{{ $sz }}">{{ $sz }}</button>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px">
                                                @foreach(['0-20k', '20k-50k', '50k-100k', '100k-150k', '150k-200k', 'Over 200k', 'Unknown'] as $range)
                                                    <button type="button" class="h2mileage-pick hub-option"
                                                        data-mileage-value="{{ $range }}"
                                                        style="justify-content:center">{{ $range }}</button>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
                                        @foreach(['Basic', 'Mid option', 'Full option', 'Unknown'] as $opt)
                                            <button type="button"
                                                class="pick-btn h2trim-pick {{ $opt === 'Full option' ? 'active' : '' }}"
                                                data-trim-value="{{ $opt }}">{{ $opt }}</button>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
                                        @foreach(['Original', 'Partial', 'Total', 'Unknown'] as $opt)
                                            <button type="button"
                                                class="pick-btn h2paint-pick {{ $opt === 'Original' ? 'active' : '' }}"
                                                data-paint-value="{{ $opt }}">{{ $opt }}</button>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
                                        @foreach(['excellent' => 'Elite', 'good' => 'Good', 'fair' => 'Fair', 'needs_work' => 'Needs Work'] as $val => $lbl)
                                            <button type="button"
                                                class="pick-btn h2condition-pick {{ $val === 'good' ? 'active' : '' }}"
                                                data-condition-value="{{ $val }}">{{ $lbl }}</button>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="field-wrap">
                                        ...
                                        <div class="hub-drawer" id="h2timeDrawer" style="padding:22px">
                                            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px">
                                                @foreach(['08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '12:00 PM', '01:00 PM', '02:00 PM', '03:00 PM', '04:00 PM', '05:00 PM', '06:00 PM', '07:00 PM'] as $slot)
                                                    <button type="button" class="h2time-pick" data-time-value="{{ $slot }}"
